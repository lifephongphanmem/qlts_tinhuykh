...
<ul id="main-menu" class="main-menu">
	...
	?> class="auto-inherit-active-class">
		...
		<ul>
			...
			<li <?php if($menu == "Dataccdc") echo "class='active'"?>>
	...
	<li>
		...
		<ul>
			...
			<li>
				<a  href="/Tracuu/TraCuuDN/nhandlaccess.php">	<i class="entypo-install"></i>
					<span class='title'>Nâng cấp dữ liệu tài sản</span>
				</a>
			</li>
		</ul>
	</li>
