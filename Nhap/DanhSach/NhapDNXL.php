...
$(document).on("click", ".open-AddBookDialog", function (e) {
 ...
 <script type="text/javascript">
	...
	function showAjaxModal1()
	{
		...
		window.location.assign('NhapDNXL.php?id='+giatri);			
	}
</script>
 <?php
...
if($tttc != "0")
{
	if(gettinhhuyen() == "Tỉnh")
		$sql = "select TTdenghi,mataisan,tentaisan,tenchitiet,ngaythang,hinhthuc,noidung,ghichu,TTQLTS from tbldenghi where madonvi like '$ma[0]%'".
	...
	while($row=mysqli_fetch_array($kq)){
		...
		$matd=$row[0]."/".$tttc."/".gettinhhuyen();
            echo"<tr>";
				...
				echo"<td>$row[6]</td>";   
				echo"<td>
						<a href=\"tinhtrangxl.php?id=$matd\" class='btn btn-info '></i>
							Xem</a>												
					</td>";				
            echo"</tr>";			
     }}         
