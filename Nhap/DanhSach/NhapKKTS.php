...
<link rel="stylesheet" type="text/css" href="/assets/News/dataTables.fixedColumns.css">
	...
	function showAjaxModal1()
	{
		...
		window.location.assign('NhapKKTS.php?id='+giatri);			
	}
</script>
<?php
	$tttc=$_GET['id'];	
...
if($tttc != "0")
{
    if(gettinhhuyen() == "Tỉnh")
	    $sql = "select TTkiemke,GIO,PHUT,ngay1,sohieu,noikiemke,noidung,ttkhac from tblkiemke where madonvi like '$ma[0]%'".
...
if(mysqli_num_rows($kq)>0){
	...
	$matd=$row[0]."/".$tttc."/".gettinhhuyen();
            echo"<tr>";
				...
				echo"<td>$row[7]</td>";	  
				echo"<td>
						<a href=\"tinhtrangkk.php?id=$matd\" class='btn btn-info '><i class='entypo-eye' ></i>
							Xem</a>												
					</td>";				
            echo"</tr>";
     }}         
