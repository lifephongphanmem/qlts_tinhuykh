...
<script language='javascript'>
 $(document).ready(function() {
  $('#DTKVcs').change(function() {
   giatri = this.value*$('#dongiacs').val();   
   $("#thanhtiencs").val(giatri);
  });
 });
</script>
...
$(document).on("click", ".open-AddBookDialog", function (e) {	
 ...
 <script type="text/javascript">
	...
	function showAjaxModal1()
	{
		...
		window.location.assign('NhapQLCC.php?id='+giatri);			
	}
</script>
<?php
	$tttc=$_GET['id'];	
...
?>					
		...
		<div class="panel-heading">
			<div class="panel-title">
				Quản lý công cụ dụng cụ lâu bền
			</div>	
...
if($tttc != "0")
{
	if(gettinhhuyen() == "Tỉnh")
		$sql = "select TTQLcc,mataisan,tentaisan,tenchitiet,ngaynhap,namsanxuat,NUOCSX,ngaysudung,noidung,DVT,DTKV,dongia,thanhtien,chitiethinhthai,GCTS from tblqlcc where madonvi like '".$ma[0]."%'".
...
if(mysqli_num_rows($kq)>0){
	...
	$stt++;
            ...
            echo"<tr>";
				...
				echo"<td>$row[8]</td>";		
                echo"<td>
						<a href=\"tinhtrangcc.php?id=$matd\" class='btn btn-info '></i>
							Xem</a>												
					</td>";
            echo"</tr>";
     }}         
				...
				<div class="modal-body">				
						<form role='form' method='POST' action = 'NhapQLCC.php' class='form-horizontal form-groups-bordered'>						
							<div class="form-group">						
								...
								<div class="col-sm-8">
									<input name="dongia" type="text" class="form-control" id="dongia">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Thành tiền:</label>
								<div class="col-sm-8">
									<input name="thanhtien" type="text" class="form-control" id="thanhtien">
								</div>								
				...
				<div class="modal-body">				
						<form role='form' method='POST' action = 'NhapQLCC.php' class='form-horizontal form-groups-bordered'>
							<div class="form-group">
								...
								<label for="field-4" class="col-sm-3 control-label">Đơn giá:</label>
								<div class="col-sm-8">
									<input name="dongiacs" type="text" class="form-control" id="dongiacs">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Thành tiền:</label>
								<div class="col-sm-8">
									<input name="thanhtiencs" type="text" class="form-control" id="thanhtiencs">
								</div>								
								<label for="field-4" class="col-sm-3 control-label">Ghi chú:</label>
								<div class="col-sm-8">
