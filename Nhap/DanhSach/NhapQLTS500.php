...
$(document).on("click", ".open-AddBookDialog", function (e) {	
 ...
 <script type="text/javascript">
	...
	function showAjaxModal1()
	{
		...
		window.location.assign('NhapQLTS500.php?id='+giatri);			
	}
</script>				
<?php
	$tttc=$_GET['id'];	
	...
	<div class="panel panel-dark">
		<div class="panel-heading">
			<div class="panel-title">
				Quản lý tài sản cố định khác trên 500 triệu
			</div>	
...
if($tttc != "0")
{
	if(gettinhhuyen() == "Tỉnh")
		$sql = "select TTQLTS,mataisan,tentaisan,tenchitiet,ngaynhap,namsanxuat,NUOCSX,ngaysudung,DTKV,DTXD,ngansach,nguonkhac,chitiethinhthai,noidung,DVT,GCTS,ttkhac from tblqlts where ngansach+nguonkhac >= 500000000 and madonvi like '$ma[0]%' and chitiethinhthai <> 'Nhà' and chitiethinhthai not Like 'Phương tiện vận tải%' and chitiethinhthai not like 'Đất%' and chitiethinhthai not like 'Quyền sử dụng đất%' and tblqlts.chitiethinhthai not like 'Vật kiến trúc%'".
...
if(mysqli_num_rows($kq)>0){
	while($row=mysqli_fetch_array($kq)){		
            ...
            $matd=$row[0]."/".$tttc."/ts5/".gettinhhuyen();
			echo"<tr>";
                echo"<td>$stt</td>";
                echo"<td>$row[2]</td>";
                echo"<td>$row[3]</td>";
                ...
                echo"<td>
						<a href=\"tinhtrangts.php?id=$matd\" class='btn btn-info '></i>
							Xem</a>	
						<a href=\"NhapQLTS500sua.php?id=$row[0]\" class='btn btn-blue '></i>
							Sửa</a>		
					</td>";
            echo"</tr>";
     }}         
