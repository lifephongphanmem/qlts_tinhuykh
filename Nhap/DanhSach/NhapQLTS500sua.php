...
function kt()
{
 ...
 <script type="text/javascript">
	...
	{		
		...
		>><a class="tieude" href='NhapQLTS500.php?id=0'>
...
if(isset($_POST["luupb"]))
	...
	{		
		...
		while($row=mysqli_fetch_array($kqts)){
			...
			$sql="Update tblqlts set mataisan='$mataisan',tentaisan='$tentaisan',tenchitiet='$tenchitiet',ngaynhap='$ngaynhap',namsanxuat='$namsanxuat',ngaysudung='$ngaysudung',ngansach=$ngansach,nguonkhac=$nguonkhac,DTKV='$DTKV',NUOCSX='$NUOCSX',chitiethinhthai='$chitiethinhthai',XOA='K',GCTS='$GCTS',DVT='$DVT',ttkhac='$ttkhac',phantram=$pthm,sonamsd=$sonamsd,sothutu=$ttsx,phantram32='$phantram32',sohaomon=$sohaomon,conlai=$conlai,xem='Chưa xem',theodoi='$theodoi',quyetdinhbangiao='$quyetdinhbangiao',ngayquyetdinhbangiao='$ngayquetdinhbangiao',hoadon='$hoadon',ngayhoadon='$ngayhoadon',lydotang = '$lydotang',giatrikhcl=$giatrikhcl,khauhao='$khauhao' WHERE TTQLTS = $id";		
		$kq=mysqli_query($con,$sql);			
...
<div class="col-sm-12">	
		...
		<fieldset>
 		<legend>Thông tin khác</legend>	
			...
			<div class="col-sm-45">
				<input name="DVT" data-validate = "required" value="<?php echo $row[8]; ?>" type="text" class="form-control" id="field-3"/>
			</div>
