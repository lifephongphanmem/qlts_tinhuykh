...
function kt()
{
 ...
 <script type="text/javascript">
	...
	{		
		...
		>><a class="tieude" href='NhapQLTSdat.php?id=0'>
...
if(isset($_POST["luupb"]))
	...
	{		
		...
		$sql="update tblqlts set mataisan='$mataisan',tentaisan='$tentaisan',tenchitiet='$tenchitiet',ngaynhap='$ngaynhap',ngaysudung='$ngaysudung',ngansach=$ngansach,nguonkhac=$nguonkhac,DTKV=$DTKV,TKVDAT='$TKVDAT',chitiethinhthai='$chitiethinhthai',XOA='K',DVT='m2',phantram=$pthm,sonamsd=$sonamsd,sothutu=$ttsx,theodoi='$theodoi',quyetdinhbangiao='$quyetdinhbangiao',ngayquyetdinhbangiao='$ngayquetdinhbangiao',giaycnqsd='$giaycnqsd',ngaygiaycnqsd='$ngaygiaycnqsd' where TTQLTS = $id";				
		$kq=mysqli_query($con,$sql);		
	...
	$sql = "select tblqlts.mataisan,tblqlts.sonamsd,tblqlts.tenchitiet,tblqlts.ngaynhap,tblqlts.ngaysudung,tblqlts.noidung,tblqlts.TKVDAT,tblqlts.DTKV,tblqlts.ngansach,tblqlts.nguonkhac,tblqlts.quyetdinhbangiao,tblqlts.ngayquyetdinhbangiao,tblqlts.giaycnqsd,tblqlts.ngaygiaycnqsd FROM tblqlts WHERE tblqlts.TTQLTS = '$id'";
	$qrsql = mysqli_query($con,$sql);
	while($row = mysqli_fetch_array($qrsql))
	{	
?>
...
<div class="col-sm-12">		
  ...
  <legend>Thông tin tài sản</legend> 
	...
	<legend>Diện tích, nguyên giá</legend>	
			...
			<label for="field-4" class="col-sm-15 control-label">Ngân sách:</label>
			<div class="col-sm-4">
...
<div class="col-sm-6" style = "display:none">	
	...
	<legend>Hao mòn/khấu hao</legend>	
			...
			<label for="field-4"  class="col-sm-4 control-label">Hao mòn TT162:</label>
			<div class="col-sm-8">
