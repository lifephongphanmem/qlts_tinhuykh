...
function kt()
{
 ...
 <script type="text/javascript">
	...
	{		
		...
		>><a class="tieude" href='NhapQLTSnha.php?id=0'>
...
if(isset($_POST["luupb"]))
	...
	if (isset($_POST['capnhatts']))
	{
		...
		$sql="update tblqlts set mataisan='$mataisan',tentaisan='$tentaisan',tenchitiet='$tenchitiet',CAPH='$CAPH',SOTA='$SOTA',DTXD='$DTXD',TDTSXD='$TDTSXD',namsanxuat='$namsanxuat',ngaynhap='$ngaynhap',ngaysudung='$ngaysudung',ngansach=$ngansach,nguonkhac=$nguonkhac,TKVDAT='$TKVDAT',phantram=$pthm,sonamsd=$sonamsd,sothutu=$ttsx,XOA='K',DVT='m2',chitiethinhthai='$chitiethinhthai',phantram32='$phantram32',sohaomon=$sohaomon,conlai=$conlai,theodoi='$theodoi',quyetdinhbangiao='$quyetdinhbangiao',ngayquyetdinhbangiao='$ngayquetdinhbangiao',bienbannghiemthu='$bienbannghiemthu',ngaybienbannghiemthu='$ngaybienbannghiemthu',lydotang = '$lydotang',giatrikhcl=$giatrikhcl,khauhao='$khauhao'  where TTQLTS = $id";
		$kq=mysqli_query($con,$sql);	
...
<div class="col-sm-12">		
  ...
  <legend>Thông tin tài sản</legend> 
			...
			<div class="col-sm-45">	
				<input name='TKVDAT' readonly class='form-control' id='TKVDAT' value = "<?php echo $row['TKVDAT'];?>"/>			
			</div>				
			...
			<div class="col-sm-45">
				<input name="SOTA" type="text" data-validate = "required" value="<?php echo $row[9]; ?>" class="form-control" id="field-3">
			</div>
			...
			<div class="col-sm-4">
				<input name="TDTSXD" type="text" data-validate = "required" value="<?php echo $row[11]; ?>" class="form-control" id="field-3">
			</div>
			<label for="field-4" style="padding-left: 0px;" class="col-sm-05 control-label">(m2)</label>			
</fieldset>
</div>	
