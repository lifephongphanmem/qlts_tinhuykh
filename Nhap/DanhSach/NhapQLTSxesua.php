...
if(isset($_POST["luupb"]))
	...
	{	
		...
		$sql="update tblqlts set mataisan='$mataisan',tentaisan='$tentaisan',tenchitiet='$tenchitiet',ngaynhap='$ngaynhap',ngaysudung='$ngaysudung',noidung='$noidung',namsanxuat='$namsanxuat',NUOCSX='$NUOCSX',BKSXE='$BKSXE',NHXE='$NHXE',CNXE='$CNXE',CXXE='$CXXE',NGGOXE='$NGGOXE',PLSD='$PLSD',CDSD='$CDSD',ngansach=$ngansach,nguonkhac=$nguonkhac,ttkhac='$ttkhac',phantram=$pthm,sonamsd=$sonamsd,sothutu=$ttsx,chitiethinhthai='$chitiethinhthai',phantram32='$phantram32',sohaomon=$sohaomon,conlai=$conlai,theodoi='$theodoi',quyetdinhbangiao='$quyetdinhbangiao',ngayquyetdinhbangiao='$ngayquetdinhbangiao',hoadon='$hoadon',ngayhoadon='$ngayhoadon',giatrikhcl=$giatrikhcl,khauhao='$khauhao' where TTQLTS = $id";
		$kq=mysqli_query($con,$sql);	
...
<div class="col-sm-12">		
  ...
  <legend>Thông tin tài sản</legend> 
			...
			<input name="namsudung" type="text" style ="display:none" value="<?php echo $row[1]; ?>" class="form-control" id ="namsudung"/>
			...
			<div class="col-sm-45">									
				<input name='noidung' readonly id='noidung' value="<?php echo $row['noidung']; ?>" data-validate = "required" class='form-control' />	
			</div>			
...
<div class="col-sm-12">	
		<fieldset>
 		<legend>Hiện trạng sử dụng</legend>							
			...
			<div class="col-sm-3">
				<input type="radio" name="hientrang" <?php if($row[26] == "Không kinh doanh") echo "checked" ; ?> value="Không kinh doanh" /> Không kinh doanh	       								
			</div>
			<div class="col-sm-3">
				<input type="radio" name="hientrang" <?php if($row[26] == "Quản lý nhà nước") echo "checked" ; ?> value="Quản lý nhà nước" /> Quản lý nhà nước	
			</div>
			<div class="col-sm-3">
				<input type="radio" name="hientrang" <?php if($row[26] == "Hoạt động khác") echo "checked" ; ?> value="Hoạt động khác" /> Hoạt động khác
			</div>									
		</fieldset>	
		<fieldset>
