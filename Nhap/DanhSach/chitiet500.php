...
?>
<h3><strong>Thông tin chi tiết tài sản</strong> </h3>
		<div class="row">
			<div class="col-md-12">
...
?>									
							...
							<div class="in">
								<input type="button" class="btn btn-black" value="Trở lại" onclick="window.location.href='NhapQLTS500.php?id=<?php echo "$key[1]"; ?>'">
