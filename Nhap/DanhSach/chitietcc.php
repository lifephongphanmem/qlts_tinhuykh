...
<ul id="main-menu" class="main-menu">
				...
				<li class="opened active">
					...
					<ul>
						...
						<li>						
							<a  href="/QLTS/Tienich/nhandlexcel.php">							
...
$sql = "Select tentaisan,tenchitiet,ngaynhap,ngaysudung,namsanxuat,NUOCSX,noidung,DVT,DTKV,dongia,thanhtien,GCTS from tblqlcc where TTQLcc = '$key[0]'";
...
?>
<h3><strong>Thông tin chi tiết công cụ</strong> </h3>
		<div class="row">
			<div class="col-md-12">
					...
					<div class="panel-body">
						<form role="form" method="POST" class="form-horizontal form-groups-bordered">
							...
							<div>
								...
								<tbody>
<?php
$sqltg = "Select ngayxuat,noisudung,soluong,dongia,sotien from tblxuatdung Where TTQLcc = '$key[0]'";
...
?>	
							...
							<div>
								...
								<tbody>
<?php
$sqlhm = "Select ngaythang,noibaohong,Lydohong,soluong,dongia,sotien from tblbaohong Where TTQLcc = '$key[0]'";
...
?>									
							...
							<div class="in">
								<input type="button" class="btn btn-black" value="Trở lại" onclick="window.location.href='NhapQLCC.php?id=<?php echo "$key[1]"; ?>'">
