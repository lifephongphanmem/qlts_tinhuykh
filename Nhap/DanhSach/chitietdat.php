...
$sql = "Select tentaisan,tenchitiet,ngaynhap,ngaysudung,DTKV,ngansach,nguonkhac,noidung,TKVDAT from tblqlts where TTQLTS = '$key[0]'";
...
?>									
							...
							<div class="in">
								<input type="button" class="btn btn-black" value="Trở lại" onclick="window.location.href='NhapQLTSdat.php?id=<?php echo "$key[1]"; ?>'">
