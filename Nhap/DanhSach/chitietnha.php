...
$sql = "Select tentaisan,tenchitiet,CAPH,SOTA,DTXD,TDTSXD,namsanxuat,noidung,ngaynhap,ngaysudung,ngansach,nguonkhac,TKVDAT,ttkhac from tblqlts where TTQLTS = '$key[0]'";
					...
					<div class="panel-body">
						<form role="form" method="POST" class="form-horizontal form-groups-bordered">
							<div class="form-group">
								...
								<label  class="col-sm-2 control-label">Cấp hạng:</label>
								<div class="col-md-4">
									<input name="CAPH" class="form-control" type="text" value = "<?php echo $row[2]; ?>">
								</div>
								<label  class="col-sm-2 control-label">Số tầng:</label>
								<div class="col-md-4">
									<input name="SOTA" class="form-control" type="text" value = "<?php echo $row[3]; ?>">
								</div>
								<label  class="col-sm-2 control-label">Diện tích:</label>
								<div class="col-md-4">
									<input name="DTXD" class="form-control" type="text" value = "<?php echo dinhdangso($row[4]); ?>">
								</div>	
								<label  class="col-sm-2 control-label">Tổng DT sàn:</label>
								<div class="col-md-4">
									<input name="TDTSXD" class="form-control" type="text" value = "<?php echo dinhdangso($row[5]); ?>">
								</div>
								...
								<div class="col-md-4">
									<input name="noidung" class="form-control" type="text" value = "<?php echo $row[7]; ?>">
								</div>
								<label  class="col-sm-2 control-label">Ngày nhập:</label>
								<div class="col-md-4">
									<input name="ngaynhap" class="form-control" type="text" value = "<?php echo doingay($row[8]); ?>">
								</div>
								<label  class="col-sm-2 control-label">Ngày sử dụng:</label>
								<div class="col-md-4">
									<input name="ngaysudung" class="form-control" type="text" value = "<?php echo doingay($row[9]); ?>">
								</div>
								<label  class="col-sm-2 control-label">Ngân sách:</label>
								<div class="col-md-4">
									<input name="ngansach" class="form-control" type="text" value = "<?php echo dinhdangso($row[10]); ?>">
								</div>								
								<label class="col-sm-2 control-label">Nguồn khác:</label>
								<div class="col-sm-4">
									<input name="nguonkhac" type="text" class="form-control" id="field-3" value = "<?php echo dinhdangso($row[11]); ?>">
								</div>
								...
								<label  class="col-sm-2 control-label">Thuộc khuôn viên:</label>
								<div class="col-md-4">
									<input name="TKVDAT" class="form-control" type="text" value = "<?php echo $row[12]; ?>">
								</div>
								<label  class="col-sm-2 control-label">Ghi chú:</label>
								<div class="col-md-10">
									<input name="ttkhac" class="form-control" type="text" value = "<?php echo $row[13]; ?>">
								</div>
							</div>	
<div>							
...
while($rowhm=@mysqli_fetch_array($kqhm))
{
	...
	echo"<tr>";
	echo "<td>".doingay($rowhm[0])."</td>";
	echo "<td>$rowhm[1]</td>";
	echo "<td>$rowhm[2]</td>";
	echo "<td>".dinhdangso($rowhm[3])."</td>";
	echo "<td>".dinhdangso($rowhm[4])."</td>";
	echo "<td>".dinhdangso($rowhm[5])."</td>";	
	echo"</tr>";
}
?>									
								</tbody>							
...
?>									
							...
							<div class="in">
								<input type="button" class="btn btn-black" value="Trở lại" onclick="window.location.href='NhapQLTSnha.php?id=<?php echo "$key[1]"; ?>'">
