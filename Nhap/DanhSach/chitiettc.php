...
$sql = "select TTcap,chitiethinhthai,mataisan,tentaisan,tengoi,caphang,ngaythang,hinhthuc,soluong,sotien from tbltrangcap where TTcap = '$key[0]'";
...
?>
<h3 style="text-align: center"><strong>Thông tin chi tiết đề nghị trang cấp</strong> </h3>
		<div class="row">
			<div class="col-md-12">
					...
					<div class="panel-body">
						<form role="form" method="POST" class="form-horizontal form-groups-bordered">
							<div class="form-group">
								<label  class="col-sm-2 control-label">Hình thái:</label>
								<div class="col-md-4">
									<input name="chitiethinhthai" class="form-control" type="text" value = "<?php echo $row[1]; ?>">
								</div>
								<label  class="col-sm-2 control-label">Mã tài sản:</label>
								<div class="col-md-4">
									<input name="mataisan" class="form-control" type="text" value = "<?php echo $row[2]; ?>">
								</div>
								<label  class="col-sm-2 control-label">Tên tài sản:</label>
								<div class="col-md-4">
									<input name="tentaisan" class="form-control" type="text" value = "<?php  echo $row[3]; ?>">
								</div>
								<label  class="col-sm-2 control-label">Tên chi tiết:</label>
								<div class="col-md-4">
									<input name="tengoi" class="form-control" type="text" value = "<?php  echo $row[4]; ?>">
								</div>
								<label  class="col-sm-2 control-label">cấp hạng:</label>
								<div class="col-md-4">
									<input name="caphang" class="form-control" type="text" value = "<?php echo $row[5]; ?>">
								</div>	
								<label  class="col-sm-2 control-label">Ngày tháng:</label>
								<div class="col-md-4">
									<input name="ngaythang" class="form-control" type="text" value = "<?php echo doingay($row[6]); ?>">
								</div>
								<label  class="col-sm-2 control-label">Hình thức:</label>
								<div class="col-md-4">
									<input name="hinhthuc" class="form-control" type="text" value = "<?php echo $row[7]; ?>">
								</div>								
								<label  class="col-sm-2 control-label">Số lượng:</label>
								<div class="col-md-4">
									<input name="soluong" class="form-control" type="text" value = "<?php echo $row[8]; ?>">
								</div>
								<label  class="col-sm-2 control-label">Dự toán:</label>
								<div class="col-md-4">
									<input name="sotien" class="form-control" type="text" value = "<?php $ngngansach=dinhdangso($row[9]); echo $ngngansach; ?>">
								</div>								
							</div>														
							<div class="in">
								<input type="button" class="btn btn-black" value="Trở lại" onclick="window.location.href='NhapDNTC.php?id=<?php echo "$key[1]"; ?>'">
