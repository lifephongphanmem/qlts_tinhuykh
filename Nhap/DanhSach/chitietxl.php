...
$sql = "select TTdenghi,mataisan,tentaisan,tenchitiet,ngaythang,hinhthuc,noidung,ghichu,TTQLTS from tbldenghi where TTdenghi = '$key[0]'";
...
?>
<h3><strong>Thông tin chi tiết đề nghị xử lý</strong> </h3>
		<div class="row">
			<div class="col-md-12">
					...
					<div class="panel-body">
						<form role="form" method="POST" class="form-horizontal form-groups-bordered">
							<div class="form-group">								
								...
								<div class="col-md-4">
									<input name="mataisan" class="form-control" type="text" value = "<?php echo $row[1]; ?>">
								</div>
								<label  class="col-sm-2 control-label">Tên tài sản:</label>
								<div class="col-md-4">
									<input name="tentaisan" class="form-control" type="text" value = "<?php  echo $row[2]; ?>">
								</div>
								<label  class="col-sm-2 control-label">Tên chi tiết:</label>
								<div class="col-md-4">
									<input name="tengoi" class="form-control" type="text" value = "<?php  echo $row[3]; ?>">
								</div>								
								<label  class="col-sm-2 control-label">Ngày xử lý:</label>
								<div class="col-md-4">
									<input name="ngaythang" class="form-control" type="text" value = "<?php echo doingay($row[4]); ?>">
								</div>
								<label  class="col-sm-2 control-label">Hình thức xử lý:</label>
								<div class="col-md-4">
									<input name="hinhthuc" class="form-control" type="text" value = "<?php echo $row[5]; ?>">
								</div>								
								<label  class="col-sm-2 control-label">Nội dung xử lý:</label>
								<div class="col-md-4">
									<input name="soluong" class="form-control" type="text" value = "<?php echo $row[6]; ?>">
								</div>
								<label  class="col-sm-2 control-label">Ghi chú:</label>
								<div class="col-md-4">
									<input name="sotien" class="form-control" type="text" value = "<?php echo $row[7]; ?>">
								</div>								
							</div>														
							<div class="in">
								<input type="button" class="btn btn-black" value="Trở lại" onclick="window.location.href='NhapDNXL.php?id=<?php echo "$key[1]"; ?>'">
