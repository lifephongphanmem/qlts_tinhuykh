...
<link rel="stylesheet" type="text/css" href="/assets/News/dataTables.fixedColumns.css">
	...
	<script type="text/javascript" language="javascript" class="init">
		...
		<hr />
		<h3>Chọn đề nghị xử lý tài sản</h3>		
...
$ab = $ma[0];
$sql = "select TTQLTS,mataisan,tentaisan,tenchitiet,chitiethinhthai from tblqlts where madonvi = '$ab' and XOA <> 'TL' and XOA <> 'DC' and XOA <> 'Bán'";
...
if(mysqli_num_rows($kq)>0){
	...
	$matm = $row[0];	
            echo"<tr>";
				...
				echo"<td>$row[4]</td>";	
				echo"<td>
						<a href=\"them.php?id=$matm\" class='btn btn-info '>
