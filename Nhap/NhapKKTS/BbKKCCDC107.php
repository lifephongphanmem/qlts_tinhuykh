    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td style="text-align: left;font-weight: bold;">
				<nobr><?php echo "Đơn vị: ".$tendv; ?></nobr>
            </td>
            <td width="40%">
            </td>
			<td style="text-align: center; font-weight: bold;"><nobr>Mẫu số C32 – HD</nobr></td>
        </tr>
		<tr>
			<td style="text-align: left;font-weight: bold;"><nobr><?php echo "Mã QHNS: ".$maqhns; ?></nobr></td>
			<td>
			</td>
			<td style="text-align: center;" ><nobr></td>
		</tr>
		</table>
<br/>
		<table cellspacing="0" cellpadding="0" border="0" style="line-height:18px">
		<tr>
            <td  style="text-align: center;font-weight: bold;height:24px;line-height:18px">BIÊN BAN KIỂM KÊ NGUYÊN LIỆU, VẬT LIỆU, CÔNG CỤ, SẢN PHẨM, HÀNG HÓA</td>
		</tr>
...
<table cellspacing="0" cellpadding="0" border="0" style="line-height:18px">
	...
	?>
	<tr>
		<td colspan="8" style="text-align: center;font-style: italic;">Số: <?php echo $sohieu;?></td>
	</tr>
	<tr>
	...
	while ($row = mysqli_fetch_array($qrsql))
	{
		...
		echo "<td style='width:40px;height:24px;line-height:18px;text-align:left;vertical-align:top;'></td>";
	...
	<table cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;">
		<tr>
			...
			<th width="15%" style="text-align: center" rowspan="3">Tên, nhãn hiệu, quy cách, phẩm chất</th>
			...
			<th width="20%"style="text-align: center" colspan="2">Phân loại</th>
			<th rowspan="3"></th>
		</tr>
		<tr>
			<th width="12%" style="text-align: center" colspan="2">Thừa</th>
			<th width="12%" style="text-align: center" colspan="2">Thiếu</th>
			<th width="12%" style="text-align: center" rowspan="2">Còn sử dụng được</th>
			<th width="12%" style="text-align: center" rowspan="2">Không sử dụng được</th>
		</tr>
		<tr>
...
<table >
	<tr>
		<td colspan="4" style="text-align: left">Ý kiến giải quyết số chênh lệch: ....................................................................................................................................................</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="25%"></td>
		<td width="25%"></td>
		<td width="25%" style="text-align: center;">Ngày ... tháng ... năm ......</td>
	</tr>
	<tr>
		<td style="text-align: center;: center; font-weight: bold;">THỦ TRƯỞNG ĐƠN VỊ</td>
		<td style="text-align: center;: center; font-weight: bold;">KẾ TOÁN TRƯỞNG</td>
		<td style="text-align: center;: center; font-weight: bold;">THỦ KHO</td>
		<td style="text-align: center; font-weight: bold;">TRƯỞNG BAN KIỂM KÊ</td>
	</tr>
	<tr>
