...
<table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;">
	...
	<tr style="vertical-align:top;">
		...
		<td class="csE9F2AA97" colspan="15" rowspan="2" style="width:595px;height:22px;line-height:18px;text-align:left;vertical-align:middle;"><nobr>T&#234;n&nbsp;đơn&nbsp;vị: </nobr> <?php echo $tendv;?></td>
		<td></td>
		<td></td>
		<td></td>
		<td></td>
	...
	<tr style="vertical-align:top;">
		...
		<td></td>
		<td></td>
		<td class="cs101A94F7" colspan="6" rowspan="4" style="width:305px;height:58px;line-height:15px;text-align:center;vertical-align:middle;"></td>
		<td></td>
	</tr>
	<tr style="vertical-align:top;">
		<td style="width:0px;height:22px;"></td>
		<td class="csE9F2AA97" colspan="15" style="width:595px;height:22px;line-height:18px;text-align:left;vertical-align:middle;"><nobr>Mã QHNS: </nobr><?php echo $maqhns;?></td>
		<td></td>
		<td></td>
		<td></td>
		<td></td>
	...
	<tr style="vertical-align:top;">
		<td style="width:0px;height:24px;"></td>
		<td colspan="27" style="width:130px;height:24px;line-height:18px;text-align:left;vertical-align:middle;font-style: italic;text-align: center"><nobr>Thời điểm kiểm kê: <?php echo $TDKK; ?></nobr></td>
	</tr>
	<tr style="vertical-align:top;">
		...
		{			
			...
			{							
				...
				echo "<tr style='vertical-align:top;'>";
					...
					echo "<td class='cs85CED65A' colspan='4' style='width:165px;height:38px;line-height:17px;text-align:left;vertical-align:middle;'><nobr style = 'white-space: pre-wrap'>".$ar2[0]."</nobr></td>";
					...
					echo "<td class='cs85CED65A' colspan='2' style='width:85px;height:38px;line-height:17px;text-align:left;vertical-align:middle;'><nobr style = 'white-space: pre-wrap'>".$ar2[2]."</nobr></td>";
	...
	<tr style="vertical-align:top;">
		...
		<td></td>
		<td class="csB6E29E9B" colspan="8" style="width:360px;height:150px;line-height:18px;text-align:center;vertical-align:bottom;"><nobr><?php echo $ttdv;; ?></nobr></td>
		<td class="csB6E29E9B" colspan="10" style="width:359px;height:150px;line-height:18px;text-align:center;vertical-align:bottom;"><nobr><?php echo $ptkt;; ?></nobr></td>
		<td class="csB6E29E9B" colspan="9" style="width:360px;height:150px;line-height:18px;text-align:center;vertical-align:bottom;"><nobr><?php echo $truongban; ?></nobr></td>
	</tr>
</table>
</body>
</html>