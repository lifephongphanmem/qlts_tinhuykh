...
$(document).on("click", ".open-addBookDialog1", function (e) {
	...
	$("#nhom1sllt").val(myBookId[1]);
	$("#nhom1nglt").val(myBookId[2]);
	$("#nhom1cllt").val(myBookId[3]);
	$("#nhom2sltt").val(myBookId[4]);
	$("#nhom2ngtt").val(myBookId[5]);
	$("#nhom2cltt").val(myBookId[6]);
	$("#nhom3slcl").val(myBookId[7]);
	$("#nhom3ngcl").val(myBookId[8]);
	$("#nhom3clcl").val(myBookId[9]);
...
//
$a=$_GET["id"];
$sql = "select TTkiemken,tentscc,tenchitiet,noisudung,chitiethinhthai,nhom1sllt,nhom1nglt,nhom1cllt,nhom2sltt,nhom2ngtt,nhom2cltt,nhom3slcl,nhom3ngcl,nhom3clcl,TTkiemke from tblkiemken where TTkiemke = '$a'";
$kq = mysqli_query($con,$sql);
$tatca = "";$stt=0;   
if(mysqli_num_rows($kq)>0){
	while($row=mysqli_fetch_array($kq)){
	$stt ++;
	$tatca = $row[0].">".$row[5].">".$row[6].">".$row[7].">".$row[8].">".$row[9].">".$row[10].">".$row[11].">".$row[12].">".$row[13].">".$row[14]; 
	$maxoa =  $row[0].">".$row[14];	
            echo "<tr"; if($row[11] != 0 || $row[12] != 0 || $row[13] != 0) echo " style='color:red;'"; echo ">";
                echo"<td>$stt</td>";                
                echo"<td>$row[2]</td>";
                echo"<td>$row[3]</td>";
				...
				echo"<td>".dinhdangso($row[9])."</td>";
				echo"<td>".dinhdangso($row[10])."</td>";
				echo"<td>".dinhdangso($row[11])."</td>";
				echo"<td>".dinhdangso($row[12])."</td>";
				echo"<td>".dinhdangso($row[13])."</td>";
                echo"<td>
						<a data-id='$tatca' title='Add this item' class='open-addBookDialog1 btn btn-blue ' href='#addBookDialog1'>Sửa</a>							
...
<?php
	 $macn = $a;
		echo "<form role='form'  method='POST' action = 'NhapKKTSct.php?id=$macn' class='form-horizontal form-groups-bordered'>";
?>
							<div class="form-group">								
										<input name="bookId" style ="display:none;" type="text" readonly tabindex="-1"	 class="form-control" id="bookId"/>
								<label class="col-sm-35 control-label">Số lượng sổ sách:</label>
								<div class="col-sm-8">
									<input name="nhom1sllt" type="text" readonly tabindex="-1" class="form-control" data-mask="fdecimal" id="nhom1sllt">
								</div>							
								<label class="col-sm-35 control-label">Nguyên giá sổ sách:</label>
								<div class="col-sm-8">
									<input name="nhom1nglt" type="text" readonly tabindex="-1" class="form-control passvalid" data-mask="fdecimal" id="nhom1nglt">
								</div>							
								<label class="col-sm-35 control-label">Giá trị còn lại sổ sách:</label>
								<div class="col-sm-8">
									<input name="nhom1cllt" type="text" readonly tabindex="-1" class="form-control passvalid" data-mask="fdecimal" id="nhom1cllt">
								</div>														
								<label class="col-sm-35 control-label">Số lượng kiểm kê:</label>
								<div class="col-sm-8">
									<input name="nhom2sltt" type="text" class="form-control" data-mask="fdecimal" id="nhom2sltt" >
								</div>							
								<label class="col-sm-35 control-label">Nguyên giá kiểm kê:</label>
								<div class="col-sm-8">
									<input name="nhom2ngtt" type="text" class="form-control passvalid" data-mask="fdecimal" id="nhom2ngtt">
								</div>							
								<label class="col-sm-35 control-label">Giá trị còn lại kiểm kê:</label>
								<div class="col-sm-8">
									<input name="nhom2cltt" type="text" class="form-control passvalid" data-mask="fdecimal" id="nhom2cltt">
								</div>														
								<label class="col-sm-35 control-label">Số lượng chênh lệch:</label>
								<div class="col-sm-8">
									<input name="nhom3slcl" type="text" readonly tabindex="-1" class="form-control" data-mask="fdecimal" id="nhom3slcl" >
								</div>							
								<label class="col-sm-35 control-label">Nguyên giá chênh lệch:</label>
								<div class="col-sm-8">
									<input name="nhom3ngcl" type="text" readonly tabindex="-1" class="form-control passvalid" data-mask="fdecimal" id="nhom3ngcl">
								</div>							
								<label class="col-sm-35 control-label">Giá trị còn lại chênh lệch:</label>
								<div class="col-sm-8">
									<input name="nhom3clcl" type="text" readonly tabindex="-1" class="form-control passvalid" data-mask="fdecimal" id="nhom3clcl">
								</div>
							</div>
