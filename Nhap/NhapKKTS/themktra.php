    ...
    function doingay1($ngay)
{
	...
	if (isset($_POST['capnhatkk']))
	{
		...
		$sql="INSERT INTO tblkiemtra(GIO,PHUT,ngay1,sohieu,noikiemke,noidung,ttkhac,madonvi,xemt,xemh) VALUES ('$GIO','$PHUT','$ngay1','$sohieu','$noikiemke','$noidung','Kiểm tra hiện trạng nhà đất','$ab','Chưa xem','Chưa xem')";
		echo  $sql;
					...
					<div class="panel-body">
						<form role="form" method="POST" class="form-horizontal form-groups-bordered"> 
							<div class="form-group">
								<label  class="col-sm-15 control-label">Giờ KT:</label>
								<div class="col-sm-1">
									<input name="GIO" class="form-control" type="text" value = "<?php echo $GIO ?>">
								</div>
								<label  class="col-sm-15 control-label">Phút KT:</label>
								<div class="col-sm-1">
							...
							<div class="form-group">
								...
								<label  class="col-sm-15 control-label">Nơi KT:</label>
								<div  >
									<?php
									...
									echo"<select name='noikiemke' class='form-control' id='noikiemke'>";
									$d=0;
							...
							<div class="form-group">
								...
								<input type="button" id="addkk" <?php if($ttkk == 0) echo "style = 'display: none';"?> class="btn btn-info" value="Thêm thành phần ban kiểm tra" onclick="<?php echo "window.location.href='themtpktra.php?id=$ttkk'" ?>" />
