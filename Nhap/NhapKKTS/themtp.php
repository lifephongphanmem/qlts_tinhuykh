...
<script type="text/javascript">
	...
	{		
		...
		<hr />			
		<h3>Nhập thành phần ban kiểm kê</h3>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">				
						<?php echo "<form role='form' method='POST' action ='themtp.php?id=$a' class='form-horizontal form-groups-bordered'>";	?>					
      ...
      <div class="modal-body">        
		<form role='form' method='POST' action =<?php echo "'themtp.php?id=$a'";?> class='form-horizontal form-groups-bordered'>
							...
							<div id = "sTTKK1" class="form-group">
								<label for="field-3" class="col-sm-3 control-label">Chức vụ cán bộ:</label>
								<div class="col-sm-5">
									<input name="chucvucanbo" readonly="false" type="text" class="form-control" id="chucvucanbo1" value = "">
								</div>
							</div>
							<div class="form-group">
								<label for="field-4" class="col-sm-3 control-label">Đại diện:</label>
