...
<div class="col-sm-12">
  ...
  <legend>Thông tin tài sản</legend> 
			...
			<div class="col-sm-45">
				<input data-inputmask="'alias': 'date'" name="ngaynhap" tabindex="-1" type="text" data-validate = "required" class="form-control" id="ngaynhap"/>
			</div>
			...
			<div class="col-sm-45">									
				<input data-mask="decimal"  name='namsanxuat' tabindex="-1" id='namsanxuat' data-validate = "required" class='form-control' />
			</div>
			...
			<?php								
			$sql="select tenphongban,maphongban from tblphongban where madonvi = '$ma[0]'";
			$sql1=mysqli_query($con,$sql);
...
<div class="col-sm-12">	
		<fieldset>
 		<legend>Hiện trạng sử dụng</legend>							
			...
			<div class="col-sm-3">
				<input type="radio" name="hientrang" checked  value="QLNN" /> Quản lý nhà nước
			</div>
			<div class="col-sm-3">
		...
		<fieldset>
 		<legend>Thông tin khác</legend>		
			...
			<?php
			$sql="select hoten from tbldanhsachcb where madonvi = '$ma[0]'";
			$sql1=mysqli_query($con,$sql);
...
<?php 	
	...
	if (isset($_POST['capnhatts'])) {
		...
		$DVT = $_POST['DVT'];
		$DTKV = $_POST['DTKV'];
		$ngansach = $_POST['ngansach'] ? kieudouble($_POST['ngansach']) : 0;
		$nguonkhac = $_POST['nguonkhac'] ? kieudouble($_POST['nguonkhac']) : 0;
		$GCTS = $_POST['GCTS'];
		$ttkhac = $_POST['ttkhac'];
		$theodoi = isset($_POST['theodoi']) ? "Theo dõi" : "Không";
