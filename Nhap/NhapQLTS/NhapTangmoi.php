...
function ktphanloai()
 ...
 function tinhtoan()
 {
	...
	var soluong = $("#soluong").val();
	 var sotiencl = $("#giatriconlaitruoc").val();
	if(soluong != "")
	...
	var sotienmoi = 0;
	var giatriconlaimoi = 0;
	if(tanggiam == "Tăng")
	{
		 sotienmoi = nguyengiamoi + parseFloat(nguyengiatruoc);
		 giatriconlaimoi = nguyengiamoi + parseFloat(giatriconlaitruoc);
	}				
	if(tanggiam == "Giảm")
	{
		 sotienmoi = parseFloat(nguyengiatruoc) - nguyengiamoi ;
		 giatriconlaimoi = parseFloat(giatriconlaitruoc) - nguyengiamoi;
	}
	 if(giatriconlaimoi < 0 || nguyengiamoi < 0)
	 {
		 alert("Nguyên giá mới không thể âm. Bạn hãy kiểm tra lại!")
 ...
 function nguyengiasoluong()
 {
	...
	{
		alert("Bạn hãy chọn phân loại nhập!")
		document.getElementById("sotienmoi").focus();
	}
	else
	{
		tinhtoan();
	...
	<fieldset>
		<legend>Thông tin chung</legend> 	
			...
			<div class="col-sm-25">
				...
				<option selected="selected" value="Tăng">Nhập tăng</option>
