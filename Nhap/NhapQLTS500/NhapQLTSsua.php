...
if(isset($_POST["luupb"]))
	...
	{		
		...
		$sql="Update tblqlts set mataisan='$mataisan',tentaisan='$tentaisan',tenchitiet='$tenchitiet',ngaynhap='$ngaynhap',namsanxuat='$namsanxuat',ngaysudung='$ngaysudung',noidung='$noidung',ngansach=$ngansach,nguonkhac=$nguonkhac,DTKV='$DTKV',NUOCSX='$NUOCSX',chitiethinhthai='$chitiethinhthai',XOA='K',GCTS='$GCTS',DVT='$DVT',ttkhac='$ttkhac',phantram=$pthm,sonamsd=$sonamsd,sothutu=$ttsx,madonvi='$ab',phantram32='$phantram32',sohaomon=$sohaomon,conlai=$conlai,theodoi='$theodoi',quyetdinhbangiao='$quyetdinhbangiao',ngayquyetdinhbangiao='$ngayquetdinhbangiao',hoadon='$hoadon',ngayhoadon='$ngayhoadon',lydotang = '$lydotang',giatrikhcl=$giatrikhcl,khauhao='$khauhao',namsudungcl='$namsudungcl',ngaythangchuyen = '$ngaythangchuyen',nguoisudung = '$nguoisudung' WHERE TTQLTS = $id";
		$kq=mysqli_query($con,$sql);			
