...
//
$sql = "select TTQLTS,mataisan,tentaisan,tenchitiet,ngaynhap,namsanxuat,NUOCSX,ngaysudung,DTKV,DTXD,ngansach,nguonkhac,chitiethinhthai,sonamsd from tblqlts where ngansach+nguonkhac >= 500000000 and madonvi = '$ab' and chitiethinhthai not like 'Nhà%' and chitiethinhthai not like 'Quyền sử dụng đất%' and chitiethinhthai not like 'Phương tiện vận tải%' and chitiethinhthai not like 'Vật kiến trúc%'";
$kq = mysqli_query($con,$sql);
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">        
		<form role='form' method='POST' action = 'NhapTang.php' class='form-horizontal form-groups-bordered'>							
							...
							<div id="thongtints1">
								<h4 class="col-sm-10"> Thông tin trước khi giảm </h4>
								<label for="field-4" class="col-sm-3 control-label">Nguyên giá:</label>
								<div class="col-sm-9">
							...
							<div >
								<h4 class="col-sm-10"> Giảm nguyên giá tài sản </h4>								
