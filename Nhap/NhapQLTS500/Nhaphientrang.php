...
//
$sql = "select TTQLTS,mataisan,tentaisan,tenchitiet,ngaynhap,namsanxuat,NUOCSX,ngaysudung,DTKV,DTXD,ngansach,nguonkhac,chitiethinhthai from tblqlts where ngansach+nguonkhac >=500000000 and madonvi = '$ma[0]' and chitiethinhthai not like 'Nhà%' and chitiethinhthai not like 'Quyền sử dụng đất%' and chitiethinhthai not like 'Phương tiện vận tải%' and chitiethinhthai not like 'Vật kiến trúc%'";
$kq = mysqli_query($con,$sql);
		...
		<form role='form' method='POST' action = 'Nhaphientrang.php' class='form-horizontal form-groups-bordered'>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									...
									<option selected='selected' value='Không KD'>Không KD</option>
									<option selected='selected' value='QLNN'>QLNN</option>
									<option selected='selected' value='HĐ khác'>HĐ khác</option>
