...
<?php	
	...
	echo "<div>";
		...
		echo "<div class='col-sm-3'>";
			echo "<input name='nguyengiatruoc1' type='text' readonly class='form-control' data-mask='fdecimal' id='nguyengiatruoc1' value = '".dinhdangso($nguyengiatruoc)."'>";
		echo "</div>";
		echo "<label for='field-4' class='col-sm-3 control-label'>Nguyên giá mới:</label>";
		echo "<div class='col-sm-3'>";
			echo "<input name='nguyengiamoi1' type='text' readonly class='form-control' data-mask='fdecimal' id='nguyengiamoi1' value = '".dinhdangso($nguyengiatruoc)."'>";
		echo "</div>";
		echo "<label for='field-4' class='col-sm-3 control-label'>GT còn lại cũ:</label>";
		echo "<div class='col-sm-3'>";
			echo "<input name='giatriconlaitruoc1' type='text' readonly class='form-control' data-mask='fdecimal' id='giatriconlaitruoc1' value = '".dinhdangso($giatriconlaitruoc)."'>";
		echo "</div>";
		echo "<label for='field-4' class='col-sm-3 control-label'>GT còn lại mới:</label>";
		echo "<div class='col-sm-3'>";
			echo "<input name='giatriconlaimoi1' type='text' readonly class='form-control' data-mask='fdecimal' id='giatriconlaimoi1' value = '".dinhdangso($giatriconlaitruoc)."'>";
		echo "</div>";
		echo "<label for='field-4' class='col-sm-3 control-label'>Số năm CL cũ:</label>";
		echo "<div class='col-sm-3'>";
			echo "<input name='namsudungconlai1' type='text' readonly class='form-control' data-mask='fdecimal' id='namsudungconlai1' value = '$namcl'>";			
		echo "</div>";		
