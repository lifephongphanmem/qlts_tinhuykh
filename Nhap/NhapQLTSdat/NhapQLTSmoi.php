...
<div class="col-sm-12">		
  ...
  <legend>Thông tin tài sản</legend> 
			...
			<div class="col-sm-45">
				<input name="TKVDAT" type="text" data-validate = "required" class="form-control" id="field-3">
			</div>
			<label for="field-4" class="col-sm-15 control-label">Ngày nhận ĐC:</label>
			<div class="col-sm-45">
				<input data-inputmask="'alias': 'date'" name="ngaythangchuyen" tabindex="-1" type="text"  class="form-control" id="ngaythangchuyen"/>
			</div>
</fieldset>		
	<fieldset>
...
<div class="col-sm-12">	
		...
		<fieldset>
 		<legend>Thông tin khác</legend>					
			...
			<div class="col-sm-4">
				<input name="giaycnqsd" type="text" class="form-control" id="field-3"/>				
			</div>
			<div class="col-sm-05">
			</div>
			<label for="field-4" class="col-sm-15 control-label">Ngày tháng:</label>
			<div class="col-sm-4">
				<input data-inputmask="'alias': 'date'" name="ngaygiaycnqsd" type="text" class="form-control" id="ngaygiaycnqsd">
			</div>	
...
<?php 	
	...
	{		
		...
		$sql="INSERT INTO tblqlts(mataisan,tentaisan,tenchitiet,ngaynhap,ngaysudung,noidung,ngansach,nguonkhac,DTKV,TKVDAT,chitiethinhthai,XOA,DVT,phantram,sonamsd,sothutu,madonvi,xemt,xemh,theodoi,quyetdinhbangiao,ngayquyetdinhbangiao,giaycnqsd,ngaygiaycnqsd,ngaythangchuyen)";
		$sql = $sql ." Values('$mataisan','$tentaisan','$tenchitiet','$ngaynhap','$ngaysudung','$noidung',$ngansach,$nguonkhac,$DTKV,'$TKVDAT','$chitiethinhthai','K','m2',$pthm,$sonamsd,$ttsx,'$ab','Chưa xem','Chưa xem','$theodoi','$quyetdinhbangiao','$ngayquetdinhbangiao','$giaycnqsd','$ngaygiaycnqsd','$ngaythangchuyen')";
		$kq=mysqli_query($con,$sql);
		$IDTS = IDTS();
