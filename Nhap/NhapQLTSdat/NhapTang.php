...
$(document).on("click", ".open-AddBookDialogg", function (e) {
 ...
 <script>	
	$(document).ready(function() {
		...
		if($('#chitiethinhthai').val() == "Nhà" || $('#chitiethinhthai').val() == "Vật kiến trúc" || $('#chitiethinhthai').val() == "Quyền sử dụng đất")
		{
			$('#tangsl').fadeIn();
	...
	$(document).ready(function() {
		...
		if($('#chitiethinhthai1').val() == "Nhà" || $('#chitiethinhthai1').val() == "Vật kiến trúc" || $('#chitiethinhthai1').val() == "Quyền sử dụng đất")
		{
			$('#tangsl1').fadeIn();
...
//
$sql = "select TTQLTS,mataisan,tentaisan,tenchitiet,ngaynhap,namsanxuat,NUOCSX,ngaysudung,DTKV,DTXD,ngansach,nguonkhac,chitiethinhthai,sonamsd from tblqlts where madonvi = '$ab' and chitiethinhthai like 'Quyền sử dụng đất%'";
$kq = mysqli_query($con,$sql);
	...
	while($row=mysqli_fetch_array($kq)){
			...
			echo "<tr"; if(ktra($row[0])) echo " style='color:red;'"; echo ">";
                ...
                echo"<td>	
						...
						<a href=\"Nhapsuatanggiam.php?id=$mamt\" class='btn btn-info' >							
							Chi tiết	
						</a>	
					</td>";
			else
				 echo"<td>							
						<a href=\"NhapTangmoi.php?id=$row[0]\" class='btn btn-warning' >							
							Nhập mới	
						</a>							
						<a href=\"Nhapsuatanggiam.php?id=$mamt\" class='btn btn-info' >							
							Chi tiết	
      ...
      <div class="modal-body"> 	  
		<form role='form' method='POST' action = 'NhapTang.php' class='form-horizontal form-groups-bordered'>
							...
							<div id="tangsl">	
								...
								<div class="col-sm-3">
									<input name="soluongmoi" type="text" readonly class="form-control" data-mask="fdecimal" id="soluongmoi">
								</div>	
								...
								<label for="field-4" class="col-sm-3 control-label">Tổng diện tích mới:</label>
								<div class="col-sm-3">
									<input name="tongdientichmoi" readonly type="text" class="form-control" data-mask="fdecimal" id="tongdientichmoi">
								</div>
							</div>
							<div>
							<h4 class="col-sm-10"> Tăng nguyên diện tích </h4>
      ...
      <div class="modal-body">        
		<form role='form' method='POST' action = 'NhapTang.php' class='form-horizontal form-groups-bordered'>							
							...
							<div id="tangsl1">	
								...
								<label for="field-4" class="col-sm-3 control-label">Diện tích mới:</label>
								<div class="col-sm-3">
									<input name="soluongmoi1" type="text" class="form-control" data-mask="fdecimal" id="soluongmoi1">
								</div>	
								<label for="field-4" class="col-sm-3 control-label">Tổng diện tích cũ:</label>
								<div class="col-sm-3">
								...
								<label for="field-4" class="col-sm-3 control-label">Tổng diện tích mới:</label>
								<div class="col-sm-3">
									<input name="tongdientichmoi1" type="text" class="form-control" data-mask="fdecimal" id="tongdientichmoi1">
								</div>
							</div>
							<div>
							<h4 class="col-sm-10"> Giảm nguyên diện tích </h4>
