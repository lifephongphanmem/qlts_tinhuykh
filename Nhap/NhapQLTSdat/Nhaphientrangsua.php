...
<?php 	
	...
	//	$soluong=kieudouble($_POST["soluong"]);
			$sql = "Update tblhientrang set ngaythang='$ngaythang',donvi='$donvi',soluong=".kieudouble($_POST["tslv"])." where ngaythang ='".$ngaythangcu."' and phanloai='Trụ sở làm việc'";											
			$kq=mysqli_query($con,$sql);		
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="text-align:center;" id="myModalLabel"><strong>Chỉnh sửa chi tiết hao mòn cố định</strong></h4>
      </div>
		...
		<?php echo "<form role='form' method='POST' action = 'Nhaphientrangsua.php?id=$a' class='form-horizontal form-groups-bordered'>"; ?>
							...
							<div id = "sTTKK1" class="form-group">
								...
								<div class="col-sm-8">
									...
									<input data-inputmask="'alias': 'date'" name="ngaythangcu" type="text" style="display:none" class="form-control" id="ngaythangcu" value = "">
								</div>
							</div>
