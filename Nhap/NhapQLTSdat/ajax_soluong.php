...
<?php	
	...
	echo "<div >";		
		...
		echo "<div class='col-sm-3'>";
			echo "<input name='soluongmoi' type='text' readonly class='form-control' data-mask='fdecimal' id='soluongmoi' >";
		echo "</div>";
		...
		echo "<div class='col-sm-3'>";
			echo "<input name='tongdientichmoi' type='text' readonly class='form-control' data-mask='fdecimal' id='tongdientichmoi'>";
		echo "</div>";
	echo "</div>";
?>