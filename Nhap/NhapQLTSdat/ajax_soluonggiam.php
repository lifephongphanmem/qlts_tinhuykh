...
<?php	
	...
	echo "<div >";
		echo "<h4 class='col-sm-10'> Giảm diện tích, thể tích </h4>";
		...
		echo "</div>";
		echo "<label for='field-4' class='col-sm-3 control-label'>Diện tích mới:</label>";
		echo "<div class='col-sm-3'>";
			echo "<input name='soluongmoi1' type='text' class='form-control' data-mask='fdecimal' id='soluongmoi1' >";
		echo "</div>";
		...
		echo "</div>";
		echo "<label for='field-4' class='col-sm-3 control-label'>Tổng diện tích mới:</label>";
		echo "<div class='col-sm-3'>";
			echo "<input name='tongdientichmoi1' type='text' class='form-control' data-mask='fdecimal' id='tongdientichmoi1'>";
		echo "</div>";
	echo "</div>";
?>