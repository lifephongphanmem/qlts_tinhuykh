...
function tongdt ()
{
    ...
    var tongdt = parseFloat(dientich) * parseFloat(tang);
    $("#TDTSXD").val(tongdt);
}
...
<div class="col-sm-12">		
  ...
  <legend>Thông tin tài sản</legend> 
			...
			<div class="col-sm-45">
				<input name="SOTA" type="text" data-validate = "required" class="form-control" id="SOTA">
			</div>
			<label for="field-3" class="col-sm-15 control-label">Diện tích<span style="padding-left:0px; color:red;">*</span>:</label>
			<div class="col-sm-4">
				<input name="DTXD" type="text" data-validate = "required" class="form-control" id="DTXD">
			</div>
			...
			<div class="col-sm-4">
				<input name="TDTSXD" type="text" data-validate = "required" class="form-control" id="TDTSXD">
			</div>
			<label for="field-4" style="padding-left: 0px;" class="col-sm-05 control-label">(m2)</label>
