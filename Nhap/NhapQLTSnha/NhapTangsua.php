...
<div class="col-sm-12">	
	...
	<fieldset>
		...
		<fieldset id="ttts">
			...
			<div class="col-sm-4">
				<input type="text" id="tongdientichtruoc" name ="tongdientichtruoc" readonly tabindex="-1" value="<?php echo $row["tongdientichtruoc"]; ?>" class="form-control"  />			
			</div>
			<label for="field-4" style="padding-left: 0px;" class="col-sm-05 control-label">(m2)</label>
			...
			<fieldset class="col-sm-6">
				...
				<div class="col-sm-8">
					<input name="soluong" type="text" value="<?php echo $row["soluong"]; ?>" onblur="nguyengiasoluong()" class="form-control" data-mask="fdecimal" id="soluong" />			
				</div>								
				<label for="field-4" style="padding-left: 0px;" class="col-sm-05 control-label">(m2)</label>
				<label for="field-4" class="col-sm-3 control-label">Diện tích sàn XD:</label>
				<div class="col-sm-8">
					<input name="tongdientich" value="<?php echo $row["tongdientich"]; ?>" type="text" onblur="nguyengiasoluong()" class="form-control" data-mask="fdecimal" id="tongdientich" />
				</div>								
				<label for="field-4" style="padding-left: 0px;" class="col-sm-05 control-label">(m2)</label>
