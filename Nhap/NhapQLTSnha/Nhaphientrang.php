...
//
$sql = "select TTQLTS,mataisan,tentaisan,tenchitiet,CAPH,SOTA,DTXD,TDTSXD,namsanxuat,noidung,ngaynhap,ngaysudung,ngansach,nguonkhac,TKVDAT,ttkhac from tblqlts where madonvi = '$ab' and chitiethinhthai like 'Nhà%'";
echo $sql;
$kq = mysqli_query($con,$sql);
$soluong =0;$ngnh="";$ngsd="";$mamt="";   $stt=0;     
if(mysqli_num_rows($kq)>0){
	while($row=mysqli_fetch_array($kq)){
			$stt++;
			$soluong = $row[8] + $row[9];$mamt=$row[0];
			$hientrang = $row[0].">".$row[7];
            echo "<tr"; if(ktra($row[0])) echo " style='color:red;'"; echo ">";
                ...
                echo"<td>						
					...
					echo"<td>						
						<a data-id='$hientrang' title='Tài sản đã bán, thanh lý hoặc điều chuyển' class='btn btn-warning '>Hiện trạng</a>							
						<a href=\"Nhaphientrangsua.php?id=$mamt\" class='btn btn-info'>							
							Chi tiết
						</a>	
					</td>";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Thêm mới hiện trạng sử dụng tài sản</h4>
      </div>
      <div class="modal-body">        
		<form role="form" method="POST" action = "Nhaphientrang.php" class="form-horizontal form-groups-bordered">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input name="donvi" type="text" class="form-control" id="field-3">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input class="form-control" name="bic" type="text">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Khác:</label>
								<div class="col-sm-8">
									<input class="form-control" name="khac" type="text">
								</div>
								<!--
								<div class="col-sm-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input name="soluong" type="text" class="form-control" data-mask="fdecimal" id="field-3">
								</div>
							</div>	
							-->
