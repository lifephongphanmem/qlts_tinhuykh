...
<?php	
	...
	echo "<fieldset>";			
			...
			echo "<label for='field-4' class='col-sm-15 control-label'>Diện tích XD:</label>";
			echo "<div class='col-sm-4'>";
				echo "	<input type='text' id = 'dientichtruoc' name ='dientichtruoc' readonly tabindex='-1' value='".dinhdangso($dientichtruoc)."' class='form-control'  />	";			
			echo "</div>";
			...
			echo "<label for='field-4' class='col-sm-15 control-label'>Diện tích sàn XD:</label>";
			echo "<div class='col-sm-4'>";
				echo "<input type='text' id='tongdientichtruoc' name ='tongdientichtruoc' readonly tabindex='-1' value='".dinhdangso($tongdientichtruoc)."'  class='form-control'  />			";
			echo "</div>";
			echo "<label for='field-4' style='padding-left: 0px;' class='col-sm-05 control-label'>(m2)</label>";
