...
<a onclick="showAjaxModal();" class='col-sm-05 btn'><img src="/icon/add.png"  style="padding-left: 0px;" height="16" width="16"/></a>
	...
	<legend>Nguyên giá</legend>									
			<label for="field-4" class="col-sm-3 control-label"> Tổng nguyên giá:</label>
			<div class="col-sm-75">
	...
	<legend>Hao mòn/khấu hao</legend>	
			...
			<label for="field-4"  class="col-sm-35 control-label">Hao mòn TT45:</label>
			<div class="col-sm-75">
