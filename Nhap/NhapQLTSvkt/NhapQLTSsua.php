...
if(isset($_POST["luupb"]))
	...
	if (isset($_POST['capnhatts']))
	{
		...
		$sql="update tblqlts set mataisan='$mataisan',tentaisan='$tentaisan',tenchitiet='$tenchitiet',DTXD='$DTXD',namsanxuat='$namsanxuat',noidung='$noidung',ngaynhap='$ngaynhap',ngaysudung='$ngaysudung',ngansach=$ngansach,nguonkhac=$nguonkhac,TKVDAT='$TKVDAT',phantram=$pthm,sonamsd=$sonamsd,sothutu=$ttsx,XOA='K',DVT='m2',chitiethinhthai='$chitiethinhthai',phantram32='$phantram32',sohaomon=$sohaomon,conlai=$conlai,theodoi='$theodoi',quyetdinhbangiao='$quyetdinhbangiao',ngayquyetdinhbangiao='$ngayquetdinhbangiao',bienbannghiemthu='$bienbannghiemthu',ngaybienbannghiemthu='$ngaybienbannghiemthu',lydotang = '$lydotang',giatrikhcl=$giatrikhcl,khauhao='$khauhao',namsudungcl = '$namsudungcl',ngaythangchuyen = '$ngaythangchuyen'  where TTQLTS = $id";
		$kq=mysqli_query($con,$sql);	
...
<div class="col-sm-12">		
  ...
  <legend>Thông tin tài sản</legend> 
			...
			<?php								
			$sql="select mataisanqd32,tentaiqd32,phantramhaomon,phantram32,namsudung from tbldanhsachqd32 Where  (chitiethinhthai like 'Vật kiến trúc%' or hinhthaitaisan like 'Vật kiến trúc%')  and mataisanqd32 Like 'TS%'";
