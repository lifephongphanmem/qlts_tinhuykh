...
//
$sql = "select TTQLTS,mataisan,tentaisan,tenchitiet,ngaynhap,namsanxuat,NUOCSX,ngaysudung,DTKV,DTXD,ngansach,nguonkhac,chitiethinhthai from tblqlts where madonvi = '$ma[0]' and chitiethinhthai = 'Vật kiến trúc' and chitiethinhthai not like 'Nhà%' and chitiethinhthai not like 'Quyền sử dụng đất%' and chitiethinhthai not like 'Phương tiện vận tải%'";
$kq = mysqli_query($con,$sql);
	...
	while($row=mysqli_fetch_array($kq)){
            ...
            echo "<tr"; if(ktra($row[0])) echo " style='color:red;'"; echo ">";
                ...
                echo"<td>						
						...
						echo"<td>						
						<a data-id='$row[0]' title='Tài sản đã bán, thanh lý hoặc điều chuyển' class='btn btn-warning '>Hiện trạng</a>							
						<a href=\"Nhaphientrangsua.php?id=$mamt\" class='btn btn-info'>
