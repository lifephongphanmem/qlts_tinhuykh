...
$(document).on("click", ".open-AddBookDialog", function (e) {	
	...
	$("#noidungcs").val(myBookId[6]);
	$("#namsanxuatcs").val(myBookId[7]);
	$("#NUOCSXcs").val(myBookId[8]);
	$("#BKSXEcs").val(myBookId[9]);
	$("#NHXEcs").val(myBookId[10]);
	$("#CNXEcs").val(myBookId[11]);
	$("#CXXEcs").val(myBookId[12]);
	$("#NGGOXEcs").val(myBookId[13]);
	$("#PLSDcs").val(myBookId[14]);
	$("#CDSDcs").val(myBookId[15]);
	$("#ngansachcs").val(myBookId[16]);
	$("#nguonkhaccs").val(myBookId[17]);
	$("#ttkhaccs").val(myBookId[18]);
	$("#phantramhaomoncs").val(myBookId[19]);
	$("#phantram32cs").val(myBookId[20]);
	$("#namhmcs").val(myBookId[21]);
	$("#soduhmcs").val(myBookId[22]);
	$("#sohmnamcs").val(myBookId[23]);
	$("#phantramhmcs").val(myBookId[24]);
	$("#sohaomoncs").val(myBookId[25]);
	$("#conlaics").val(myBookId[26]);
	$("#TThaomon").val(myBookId[27]);
...
$(document).on("click", ".open-AddBookDialog1", function (e) {	
	...
	$("#ngaysudungc").val(myBookId[5]);
	$("#noidungc").val(myBookId[6]);
	$("#namsanxuatc").val(myBookId[7]);
	$("#NUOCSXc").val(myBookId[8]);
	$("#BKSXEc").val(myBookId[9]);
	$("#NHXEc").val(myBookId[10]);
	$("#CNXEc").val(myBookId[11]);
	$("#CXXEc").val(myBookId[12]);
	$("#NGGOXEc").val(myBookId[13]);
	$("#PLSDc").val(myBookId[14]);
	$("#CDSDc").val(myBookId[15]);
	$("#ngansachc").val(myBookId[16]);
	$("#nguonkhacc").val(myBookId[17]);
	$("#ttkhacc").val(myBookId[18]);
	$("#phantramhaomonc").val(myBookId[19]);
	$("#phantram32c").val(myBookId[20]);
	$("#namhmc").val(myBookId[21]);
	$("#soduhmc").val(myBookId[22]);
	$("#sohmnamc").val(myBookId[23]);
	$("#phantramhmc").val(myBookId[24]);
	$("#sohaomonc").val(myBookId[25]);
	$("#conlaic").val(myBookId[26]);
    $(_self.attr('href')).modal('show');		
});
 </script>
...
function kt()
{
 ...
 <script type="text/javascript">
	...
	function showAjaxModal1()
	{
		...
		<hr />		
		<h3>Quản lý xe và phương tiện vận tải và các phương tiện vận tải khác</h3>		
...
<?php 	
	...
	{	
		...
		$BKSXEcs = $_POST['BKSXEcs'];
		$NHXEcs = $_POST['NHXEcs'];
		$CNXEcs = $_POST['CNXEcs'];
		$CXXEcs = $_POST['CXXEcs'];
		$NGGOXEcs = $_POST['NGGOXEcs'];
		$PLSDcs = $_POST['PLSDcs'];		
		$CDSDcs = $_POST['CDSDcs'];
		if($_POST['ngansachcs'])
		...
		$sql="Update tblqlts set mataisan='$mataisancs',tentaisan='$tentaisancs',tenchitiet='$tenchitietcs',ngaynhap='$ngaynhapcs',ngaysudung='$ngaysudungcs',noidung='$noidungcs',";
		$sql = $sql ."namsanxuat=$namsanxuatcs,NUOCSX='$NUOCSXcs',BKSXE='$BKSXEcs',NHXE='$NHXEcs',CNXE=$CNXEcs,CXXE='$CXXEcs',NGGOXE='$NGGOXEcs',PLSD='$PLSDcs',CDSD='$CDSDcs',ngansach=$ngansachcs,nguonkhac=$nguonkhaccs";
		$sql = $sql .",ttkhac='$ttkhaccs',phantram=$pthmcs,sonamsd=$sonamsdcs,sothutu=$ttsxcs,XOA='K',DVT='Chiếc',chitiethinhthai='$chitiethinhthaics',phantram32=$phantram32cs,sohaomon=$sohaomoncs,conlai=$conlaics";
...
if(isset($_GET['id'])) {
	...
	{	
		...
		$sql="INSERT INTO tblqlts(mataisan,tentaisan,tenchitiet,ngaynhap,ngaysudung,noidung,namsanxuat,NUOCSX,BKSXE,NHXE,CNXE,CXXE,NGGOXE,PLSD,CDSD,ngansach,nguonkhac,ttkhac,phantram,sonamsd,sothutu,XOA,DVT,chitiethinhthai,madonvi,phantram32,sohaomon,conlai,xem,DTKV)";
		$sql = $sql ." Values('$mataisan','$tentaisan','$tenchitiet','$ngaynhap','$ngaysudung','$noidung','$namsanxuat','$NUOCSX','$BKSXE','$NHXE','$CNXE','$CXXE','$NGGOXE','$PLSD','$CDSD',$ngansach,$nguonkhac,'$ttkhac',$pthm,$sonamsd,$ttsx,'K','Chiếc','$chitiethinhthai','$ab','$phantram32',$sohaomon,$conlai,'Chưa xem',1)";			
		$kq=mysqli_query($con,$sql);	
		$IDTS = IDTS();
...
if(isset($_GET['id'])){
	$tttc=$_GET['id'];
	$key=explode(">",$tttc);
	$sql = "select tblqlts.TTQLTS,tblqlts.mataisan,tblqlts.tentaisan,tblqlts.tenchitiet,tblqlts.ngaynhap,tblqlts.ngaysudung,tblqlts.noidung," .
		"tblqlts.namsanxuat,tblqlts.NUOCSX,tblqlts.BKSXE,tblqlts.NHXE,tblqlts.CNXE,tblqlts.CXXE,tblqlts.NGGOXE,tblqlts.PLSD,tblqlts.CDSD," .
		"tblqlts.ngansach,tblqlts.nguonkhac,tblqlts.ttkhac" .
		...
		" where tblqlts.madonvi = '$ab'".
		($key[0] !=""?" and noidung = '".$key[0]."'":"").
		($key[1] !=""?" and nguoisudung = '".$key[1]."'":"").
		" and (tblqlts.chitiethinhthai Like 'Xe ô tô%' or tblqlts.chitiethinhthai Like 'Phương tiện vận tải%')" .
	...
	$sql = "select tblqlts.TTQLTS,tblqlts.mataisan,tblqlts.tentaisan,tblqlts.tenchitiet,tblqlts.ngaynhap,tblqlts.ngaysudung,tblqlts.noidung," .
		...
		",tblqlts.phantram,tblqlts.phantram32,tblhaomon.namhaomon,tblhaomon.sodu,tblhaomon.sotien,tblhaomon.phantram,tblqlts.sohaomon,tblqlts.conlai,tblhaomon.TThaomon" .
		" from tblqlts inner join tblhaomon on tblqlts.TTQLTS = tblhaomon.TTQLTS" .
		" where tblqlts.madonvi = '$ab' and (tblqlts.chitiethinhthai Like 'Xe ô tô%' or tblqlts.chitiethinhthai Like 'Phương tiện vận tải%')" .
		" and tblhaomon.TThaomon in (Select Min(TThaomon) as TThaomon from tblhaomon group by TTQLTS) order by TTQLTS DESC";
}
$kq = mysqli_query($con,$sql);
$ngnh="";$ngsd="";   
...
if(mysqli_num_rows($kq)>0){
	while($row=mysqli_fetch_array($kq)){		
			$stt++;			
			$nguyengia = $row[16] + $row[17];
			$tatca = $row[0].">".$row[1].">".$row[2].">".$row[3].">".doingay1($row[4]).">".doingay1($row[5]).">".$row[6].">".$row[7].">".$row[8].">".$row[9].">".$row[10].">".$row[11].">".$row[12].">".$row[13].">".$row[14].">".$row[15].">".$row[16].">".$row[17].">".$row[18].">".$row[19].">".$row[20].">".$row[21].">".$row[22].">".$row[23].">".$row[24].">".$row[25].">".$row[26].">".$row[27];
			$xoa = $row[0].">".$ab;
            echo"<tr>";   				
				echo"<td>$stt</td>";                
                echo"<td>$row[3]</td>";
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title" style="text-align:center;"><strong>Nhập thông tin tài sản xe</strong></h4>
				</div>				
				<div class="modal-body">				
						<?php echo "<form role='form' name='nhapmoi' onsubmit='return kt()' method='POST' action = 'NhapQLTS.php' class='form-horizontal form-groups-bordered'>"; ?>
							<div class="form-group">
								<label class="col-sm-3 control-label">Tên tài sản:</label>
								<?php								
								$sql="select mataisanqd32,tentaiqd32 from tbldanhsachqd32 Where chitiethinhthai like 'Phương tiện vận tải %' and mataisanqd32 Like 'TS%'";
								...
								<label for="field-4" class="col-sm-3 control-label">Biển số:</label>
								<div class="col-sm-3">
									<input name="BKSXE" type="text" class="form-control" id="field-3">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Nhã hiệu:</label>
								<div class="col-sm-3">
									<input name="NHXE" type="text" class="form-control" id="field-3">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Tải trọng:</label>
								<div class="col-sm-3">
									<input name="CNXE" type="text" class="form-control" id="field-3">
								</div>
								<label for="field-3" class="col-sm-3 control-label">Công xuất:</label>
								<div class="col-sm-3">
									<input name="CXXE" type="text" class="form-control" id="field-3">
								</div>								
								<label for="field-4" class="col-sm-3 control-label">Nguồn gốc:</label>
								<div class="col-sm-9">
									<input name="NGGOXE" type="text" class="form-control" id="field-3">
								</div>
								<label for="field-3" class="col-sm-3 control-label">Phân loại SD:</label>
								<div class="col-sm-9">									
								...
								<label for="field-4" class="col-sm-3 control-label">Chức danh:</label>
								<div class="col-sm-9">
...
<div class="modal fade" id="addBookDialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">				
						<?php echo "<form role='form' method='POST' action = 'NhapQLTS.php' class='form-horizontal form-groups-bordered'>"; ?>
							<div class="form-group">
								...
								<label for="field-4" class="col-sm-3 control-label">Biển số:</label>
								<div class="col-sm-3">
									<input name="BKSXEcs" type="text" class="form-control" id="BKSXEcs">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Nhã hiệu:</label>
								<div class="col-sm-3">
									<input name="NHXEcs" type="text" class="form-control" id="NHXEcs">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Tải trọng:</label>
								<div class="col-sm-3">
									<input name="CNXEcs" type="text" class="form-control" id="CNXEcs">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Công xuất:</label>
								<div class="col-sm-3">
									<input name="CXXEcs" type="text" class="form-control" id="CXXEcs">
								</div>								
								<label for="field-4" class="col-sm-3 control-label">Nguồn gốc:</label>
								<div class="col-sm-9">
									<input name="NGGOXEcs" type="text" class="form-control" id="NGGOXEcs">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Phân loại SD:</label>
								<div class="col-sm-9">									
									<select name='PLSDcs' class='form-control' id="PLSDcs">									
									<option selected='selected' value='Xe phục vụ chức danh'>Xe phục vụ chức danh</option>
									<option selected='selected' value='Xe phục vụ chung'>Xe phục vụ chung</option>
									<option selected='selected' value='Xe chuyên dùng'>Xe chuyên dùng</option>
									<option selected='selected' value=''>Chọn phân loại</option>
								...
								<label for="field-4" class="col-sm-3 control-label">Chức danh:</label>
								<div class="col-sm-9">
									<input name="CDSDcs" type="text" class="form-control" id="CDSDcs">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Ngân sách:</label>
								<div class="col-sm-3">
				...
				<div class="modal-body">						
						<?php echo "<form role='form' method='POST' action = 'NhapQLTS.php' class='form-horizontal form-groups-bordered'>"; ?>
							...
							<div class="form-group" id="ttct" style="display:none">	
								...
								<label for="field-4" class="col-sm-3 control-label">Biển số:</label>
								<div class="col-sm-3">
									<input name="BKSXEc" type="text" class="form-control" id="BKSXEc">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Nhã hiệu:</label>
								<div class="col-sm-3">
									<input name="NHXEc" type="text" class="form-control" id="NHXEc">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Tải trọng:</label>
								<div class="col-sm-3">
									<input name="CNXEc" type="text" class="form-control" id="CNXEc">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Công xuất:</label>
								<div class="col-sm-3">
									<input name="CXXEc" type="text" class="form-control" id="CXXEc">
								</div>								
								<label for="field-4" class="col-sm-3 control-label">Nguồn gốc:</label>
								<div class="col-sm-9">
									<input name="NGGOXEc" type="text" class="form-control" id="NGGOXEc">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Phân loại SD:</label>
								<div class="col-sm-9">									
									<select name='PLSDc' class='form-control' id="PLSDc">									
									<option selected='selected' value='Xe phục vụ chức danh'>Xe phục vụ chức danh</option>
									<option selected='selected' value='Xe phục vụ chung'>Xe phục vụ chung</option>
									<option selected='selected' value='Xe chuyên dùng'>Xe chuyên dùng</option>
									<option selected='selected' value=''>Chọn phân loại</option>
								...
								<label for="field-4" class="col-sm-3 control-label">Chức danh:</label>
								<div class="col-sm-9">
									<input name="CDSDc" type="text" class="form-control" id="CDSDc">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Ngân sách:</label>
								<div class="col-sm-3">
