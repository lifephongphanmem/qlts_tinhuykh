...
if(isset($_POST["luupb"]))
	...
	{	
		...
		$sql="update tblqlts set mataisan='$mataisan',tentaisan='$tentaisan',tenchitiet='$tenchitiet',ngaynhap='$ngaynhap',ngaysudung='$ngaysudung',noidung='$noidung',namsanxuat='$namsanxuat',NUOCSX='$NUOCSX',BKSXE='$BKSXE',NHXE='$NHXE',CNXE='$CNXE',CXXE='$CXXE',NGGOXE='$NGGOXE',PLSD='$PLSD',CDSD='$CDSD',ngansach=$ngansach,nguonkhac=$nguonkhac,ttkhac='$ttkhac',phantram=$pthm,sonamsd=$sonamsd,sothutu=$ttsx,chitiethinhthai='$chitiethinhthai',phantram32='$phantram32',sohaomon=$sohaomon,conlai=$conlai,theodoi='$theodoi',quyetdinhbangiao='$quyetdinhbangiao',ngayquyetdinhbangiao='$ngayquetdinhbangiao',hoadon='$hoadon',ngayhoadon='$ngayhoadon',giatrikhcl=$giatrikhcl,khauhao='$khauhao',namsudungcl='$namsudungcl',ngaythangchuyen = '$ngaythangchuyen', nguoisudung = '$nguoisudung' where TTQLTS = $id";
		$kq=mysqli_query($con,$sql);
		...
		$kq=mysqli_query($con,$sql);
		$sql = "update tblhientrang set ngaythang='$ngaynhap',phanloai='$phanloai' WHERE TTTS = $id";	
		$kq=mysqli_query($con,$sql);
	    header("Location:NhapQLTS.php");
	}
	$sql = "select tblqlts.mataisan,tblqlts.sonamsd,tblqlts.tenchitiet,tblqlts.ngaynhap,tblqlts.ngaysudung,tblqlts.namsanxuat,tblqlts.NUOCSX,tblqlts.noidung,tblqlts.BKSXE,tblqlts.NHXE,tblqlts.CNXE,tblqlts.CXXE,tblqlts.NGGOXE,tblqlts.PLSD,tblqlts.CDSD,tblqlts.ngansach,tblqlts.nguonkhac,tblqlts.phantram,tblqlts.phantram32,tblqlts.sohaomon,tblqlts.conlai,tblqlts.ttkhac,tblhaomon.namhaomon,tblhaomon.sodu,tblhaomon.sotien,tblhaomon.phantram,tblhientrang.phanloai,tblqlts.quyetdinhbangiao,tblqlts.ngayquyetdinhbangiao,tblqlts.hoadon,tblqlts.ngayhoadon,tblqlts.lydotang,tblqlts.khauhao,tblqlts.giatrikhcl,tblhaomon.ngaykhauhao,tblhaomon.namkhconlai,tblhaomon.phuongphapkhauhao,tblhaomon.thangkhauhaoconlai,tblhaomon.tylekhauhao,tblhaomon.tylesxkd,tblhaomon.sokhauhao,tblhaomon.sokhnam,tblqlts.namsudungcl,tblqlts.ngaythangchuyen,tblqlts.nguoisudung".
...
<div class="col-sm-12">		
  ...
  <legend>Thông tin tài sản</legend> 
			...
			echo"</div>";
			?>		
			<input name="mataisan" type="text" style ="display:none" value="<?php echo $row[0]; ?>" class="form-control" id="mataisan"/>
			...
			<div class="col-sm-45">
				<input data-inputmask="'alias': 'date'" name="ngaynhap" type="text" value="<?php echo doingay1($row[3]); ?>" data-validate = "required" class="form-control" id="ngaynhap"/>
			</div>
			<label for="field-4" class="col-sm-15 control-label">Ngày sử dụng:</label>
			<div class="col-sm-45">
				<input data-inputmask="'alias': 'date'" name="ngaysudung" type="text" value="<?php echo doingay1($row[4]); ?>" data-validate = "required" class="form-control" id="ngaysudung"/>
			</div>
			...
			<div class="col-sm-45">
				<input name="BKSXE" type="text" value="<?php echo $row[8]; ?>" class="form-control" id="field-3">
			</div>
			<label for="field-4" class="col-sm-15 control-label">Nhã hiệu:</label>
			<div class="col-sm-45">
				<input name="NHXE" type="text" value="<?php echo $row[9]; ?>" class="form-control" id="field-3">
			</div>
			<label for="field-4" class="col-sm-15 control-label">Tải trọng:</label>
			<div class="col-sm-45">
				<input name="CNXE" type="text" value="<?php echo $row[10]; ?>" class="form-control" id="field-3">
			</div>
			<label for="field-3" class="col-sm-15 control-label">Công xuất:</label>
			<div class="col-sm-45">
				<input name="CXXE" type="text" value="<?php echo $row[11]; ?>" class="form-control" id="field-3">
			</div>								
			<label for="field-4" class="col-sm-15 control-label">Lý do tăng<span style="padding-left:0px; color:red;">*</span>:</label>
			<div class="col-sm-45" >
				<Select name="NGGOXE"   class="form-control" id ="NGGOXE">
				<option <?php if($row['NGGOXE'] == "Mua mới") echo "selected='selected'";?> value="Mua mới">Mua mới</option>
				<option <?php if($row['NGGOXE'] == "Được tiếp nhận") echo "selected='selected'";?> value="Được tiếp nhận">Được tiếp nhận</option>
					<option <?php if($row['NGGOXE'] == "Thuê") echo "selected='selected'";?> value="Thuê">Thuê</option>
					<option <?php if($row['NGGOXE'] == "Khác") echo "selected='selected'";?> value="Khác">Khác</option>
				</select>
			</div>
			<label for="field-3" class="col-sm-15 control-label">Phân loại SD:</label>
			<div class="col-sm-45">									
				<select name='PLSD' class='form-control'>									
				<option <?php if($row['PLSD'] == "Xe phục vụ chức danh") echo "selected='selected'";?> value='Xe phục vụ chức danh'>Xe phục vụ chức danh</option>
				<option <?php if($row['PLSD'] == "Xe phục vụ chung") echo "selected='selected'";?> value='Xe phục vụ chung'>Xe phục vụ chung</option>
				<option <?php if($row['PLSD'] == "Xe chuyên dùng") echo "selected='selected'";?> value='Xe chuyên dùng'>Xe chuyên dùng</option>
				<option <?php if($row['PLSD'] == "") echo "selected='selected'";?> value=''>Chọn phân loại</option>
				</select>
			</div>
			<label for="field-4" class="col-sm-15 control-label">Chức danh:</label>
			<div class="col-sm-45">
				<input name="CDSD" type="text" value="<?php echo $row[14]; ?>" class="form-control" id="field-3">
			</div>
			<label for="field-4" class="col-sm-15 control-label">Nguồn ngân sách:</label>
			<div class="col-sm-4">
				<input name="ngansach" type="text" class="form-control" value="<?php echo $row[15]; ?>" data-mask="fdecimal" id="ngansach"/>
			</div>
			...
			<div class="col-sm-4">
				<input name="nguonkhac" type="text" class="form-control" value="<?php echo $row[16]; ?>" data-mask="fdecimal" id="nguonkhac"/>
			</div>
			<label for="field-4" style="padding-left: 0px;" class="col-sm-05 control-label">(VNĐ)</label>
			<label for="field-4" class="col-sm-15 control-label"> Tổng nguyên giá:</label>
			<div class="col-sm-4">
				<input name="nguyengia" type="text" value="<?php echo (kieudouble($row[16])+kieudouble($row[15])); ?>" readonly tabindex="-1" class="form-control" data-mask="fdecimal" id="nguyengia"/>
			</div>
			<label for="field-4" style="padding-left: 0px;" class="col-sm-05 control-label">(VNĐ)</label>
		<label for="field-4" class="col-sm-15 control-label">Ngày nhận ĐC:</label>
		<div class="col-sm-45">
			<input data-inputmask="'alias': 'date'" name="ngaythangchuyen" tabindex="-1" type="text" data-validate = "" class="form-control" value="<?php echo doingay1($row['ngaythangchuyen']); ?>" id="ngaythangchuyen"/>
		</div>
			</fieldset>
</fieldset>
</div>
<div class="col-sm-12">
	...
	<legend>Hao mòn/khấu hao</legend>
			...
			<div class="col-sm-35">
				<input name="phantramhaomon" readonly tabindex="-1" value="<?php echo $row[17]; ?>" type="text" class="form-control" id ="phantramhaomon"/>
			</div>
			...
			<div class="col-sm-35">
				<input name="phantram32"  type="text" readonly tabindex="-1" value="<?php echo $row[18]; ?>" class="form-control" id ="phantram32"/>
			</div>
			<label for="field-4" style="padding-left: 0px;" class="col-sm-05 control-label">(%)</label>
			...
			<div class="col-sm-35">
				<input name="sohaomon" type="text" value="<?php echo $row[19]; ?>" class="form-control" data-mask="fdecimal" id="sohaomon"/>
			</div>
			<label for="field-4" style="padding-left: 0px;" class="col-sm-05 control-label">(VNĐ)</label>
			<label for="field-4" class="col-sm-2 control-label">Giá trị còn lại:</label>
			<div class="col-sm-35">
				<input name="conlai" type="text" class="form-control" value="<?php echo $row[20]; ?>" data-mask="fdecimal" id="conlai"/>
			</div>
			<label for="field-4" style="padding-left: 0px;" class="col-sm-05 control-label">(VNĐ)</label>
...
<div class="col-sm-12">	
		<fieldset>
 		<legend>Hiện trạng sử dụng</legend>							
			<div class="col-sm-3">
				<input type="radio" name="hientrang" <?php if($row[26] == "Kinh doanh") echo "checked" ; ?>   value="Kinh doanh" /> Kinh doanh	
			</div>	
			<div class="col-sm-3">
				<input type="radio" name="hientrang" <?php if($row[26] == "Không KD") echo "checked" ; ?> value="Không KD" /> Không kinh doanh	       								
			</div>
			<div class="col-sm-3">
				<input type="radio" name="hientrang" <?php if($row[26] == "QLNN") echo "checked" ; ?> value="QLNN" /> Quản lý nhà nước	
			</div>
			<div class="col-sm-3">
				<input type="radio" name="hientrang" <?php if($row[26] == "HĐ khác") echo "checked" ; ?> value="HĐ khác" /> Hoạt động khác
			</div>									
		</fieldset>	
		<fieldset>
 		<legend>Thông tin khác</legend>							
			...
			<div class="col-sm-45">
				<input name="quyetdinhbangiao" value="<?php echo $row[27]; ?>" type="text" class="form-control" id="field-3"/>									
			</div>
			<label for="field-4" class="col-sm-15 control-label">Ngày tháng:</label>
			<div class="col-sm-45">
				<input data-inputmask="'alias': 'date'" name="ngayquyetdinhbangiao" value="<?php echo doingay1($row[28]); ?>" type="text" class="form-control" id="ngayquyetdinhbangiao">
			</div>	
			<label for="field-4" class="col-sm-15 control-label">Hóa đơn:</label>
			<div class="col-sm-45">
				<input name="hoadon" type="text" value="<?php echo $row[29]; ?>" class="form-control" id="field-3"/>									
			</div>
			<label for="field-4" class="col-sm-15 control-label">Ngày tháng:</label>
			<div class="col-sm-45">
				<input data-inputmask="'alias': 'date'" name="ngayhoadon" value="<?php echo doingay1($row[30]); ?>" type="text" class="form-control" id="ngayhoadon">			
			</div>
			...
			<input name="namhm" type="text" style="display:none" value="<?php echo $row[22]; ?>" class="form-control" id ="namhm"/>
			<input name="soduhm" type="text" style="display:none" value="<?php echo $row[23]; ?>" class="form-control" id ="soduhm"/>
			<input name="sohmnam" type="text" style="display:none" value="<?php echo $row[24]; ?>" class="form-control" id ="sohmnam"/>
			<input name="phantramhm" type="text" style="display:none" value="<?php echo $row[25]; ?>" class="form-control" id ="phantramhm"/>
