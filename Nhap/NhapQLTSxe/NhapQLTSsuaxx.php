...
<div class="col-sm-12">		
  ...
  <legend>Thông tin tài sản</legend> 
			...
			<?php								
			$sql="select mataisanqd32,tentaiqd32,phantramhaomon,phantram32,namsudung from tbldanhsachqd32 Where chitiethinhthai like 'Phương tiện vận tải %' and mataisanqd32 Like 'TS%'";
			...
			<label for="field-4" style="padding-left: 0px;" class="col-sm-05 control-label">(VNĐ)</label>
			<label for="field-4" class="col-sm-6 control-label"></label>
		...
		<fieldset>
 		<legend>Thông tin khác</legend>							
			...
			<div class="col-sm-105">
				<input name="ttkhac" type="text" value="<?php echo $row[21]; ?>" class="form-control" id="field-3"/>									
			</div>															
