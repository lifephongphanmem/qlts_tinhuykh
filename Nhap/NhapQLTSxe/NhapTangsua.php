	...
	<fieldset>
		<legend>Thông tin chung</legend> 	
			...
			<div class="col-sm-25">
				...
				<option <?php if($row["tanggiam"] == "Thu hồi") echo "selected = 'selected'";?> value="Thu hồi">Thu hồi</option>
				<option <?php if($row["tanggiam"] == "Thanh lý") echo "selected = 'selected'";?> value="Thanh lý">Thanh lý</option>
				</select>
			</div>	
