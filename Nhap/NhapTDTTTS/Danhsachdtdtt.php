...
<link rel="stylesheet" type="text/css" href="/assets/News/dataTables.fixedColumns.css">
	...
	<script type="text/javascript" language="javascript" class="init">
		...
		<hr />		
		<h3>Chọn tài sản thay đổi thông tin</h3>	
		<input type="button" class="btn btn-black" value="Trở lại" onclick="<?php echo "window.location.href='NhapTDTTTS.php'" ?>" />
...
$ab = $ma[0];
$sql = "select TTQLTS,chitiethinhthai,mataisan,tentaisan,tenchitiet,ngaysudung,noidung,DVT,DTKV,DTXD,ngansach,nguonkhac from tblqlts";
$sql = $sql . " where madonvi = '$ab' and TTQLTS Not in (Select ttts From tblthaydoi Where madonvi = '$ab' Group by ttts)";
	...
	while($row=mysqli_fetch_array($kq)){
		$sl=$row[8] + $row[9];$ng = $row[10]+$row[11];
            echo"<tr>";
				...
				echo"<td>
						<a href=\"NhapTDTTTSchon.php?id=$row[0]\" class='btn btn-info '>
