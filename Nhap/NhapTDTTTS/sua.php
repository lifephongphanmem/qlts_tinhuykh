...
$maid= $_GET['id'];
$key = explode(">",$maid);
$sql = "SELECT * FROM tblthaydoi WHERE ttthaydoi='$key[1]'";
...
?>
						...
						<form role="form" method="POST" class="form-horizontal form-groups-bordered">
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-5">
									...
									<?php										
										echo "<a href='NhapTDTTTSchon.php?id=$key[0]' class='btn btn-success'>
											Trở lại
										</a>";
									?>
								</div>
	...
	if (isset($_POST['sua']))
	{
		if ($_POST[NTTD] != "")
		{
			...
			$sqlin = "Update tblthaydoi Set NTTD='$ngaythaydoi',TTTD='$_POST[TTTD]',LDTD='$_POST[LDTD]',GCTD='$_POST[GCTD]' WHERE ttthaydoi = ".$key[1];
			echo $sqlin;
			...
			header("location: NhapTDTTTSchon.php?id=$key[0]");
		}
	}
?>	
</div>
