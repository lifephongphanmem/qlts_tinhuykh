...
<table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;">
	...
	function tondk($mats,$tungay)
	{
		...
		global $con;
		$kq=0;	
		$sql = "Select DTKV From tblqlcc Where madonvi Like '$msdv%' and TTQLcc = '" . $mats . "' and ngaysudung < '" . doingay($tungay) . "'";
		$qrsql = mysqli_query($con,$sql);
		while($row=mysqli_fetch_array($qrsql))	
		{
			$kq = $kq + kieudouble($row['DTKV']);
		}
		$sql = "Select tblbaohong.soluong From tblbaohong INNER JOIN tblqlcc ON tblbaohong.TTQLcc = tblqlcc.TTQLcc Where tblqlcc.madonvi Like '$msdv%' and tblqlcc.TTQLcc = '" . $mats . "' and tblbaohong.ngaythang < '" . doingay($tungay) . "'";		
		$qrsql = mysqli_query($con,$sql);
		while($row=mysqli_fetch_array($qrsql))				
		{
			$kq = $kq - kieudouble($row['soluong']);
		}
		return $kq;
	}
	function nhaptk($mats,$tungay,$denngay)
	{
		...
		global $con;
		$kq=0;
		$sql = "Select DTKV From tblqlcc Where madonvi Like '$msdv%' and  TTQLcc = '" . $mats . "' and ngaysudung Between '" . doingay($tungay) . "' and '" . doingay($denngay) . "'";
		$qrsql = mysqli_query($con,$sql);
		while($row=mysqli_fetch_array($qrsql))		
		{
			$kq = $kq + kieudouble($row['DTKV']);
	...
	function xuattk($mats,$tungay,$denngay)
	{
		...
		global $con;
		$kq= 0;
		$sql = "Select tblbaohong.soluong FROM tblbaohong INNER JOIN tblqlcc ON tblbaohong.TTQLcc = tblqlcc.TTQLcc Where tblqlcc.madonvi Like '$msdv%' and tblqlcc.TTQLcc = '" . $mats . "' and tblbaohong.ngaythang Between '" . doingay($tungay) . "' and '" . doingay($denngay) . "'";
		$qrsql = mysqli_query($con,$sql);
		while($row = mysqli_fetch_array($qrsql))
		{
			$kq = $kq + kieudouble($row['soluong']);
	...
	echo "<tr style='vertical-align:top;'>";
		...
		echo "<td class='cs7DC1BDF5' style='width:42px;height:39px;line-height:18px;text-align:center;vertical-align:middle;'><nobr>$stt</nobr></td>";
		echo "<td class='cs1D0A4484' style='width:218px;height:39px;line-height:18px;text-align:left;vertical-align:middle;'><nobr>$ten1</nobr></td>";
		echo "<td class='cs8556A6FD' style='width:76px;height:39px;line-height:18px;text-align:center;vertical-align:middle;'><nobr>$ten3</nobr></td>";
		echo "<td class='cs8556A6FD' colspan='2' style='width:76px;height:39px;line-height:18px;text-align:center;vertical-align:middle;'><nobr>$sl1</nobr></td>";
		echo "<td class='cs8556A6FD' style='width:75px;height:39px;line-height:18px;text-align:center;vertical-align:middle;'><nobr>$sl2</nobr></td>";
		echo "<td class='cs8556A6FD' style='width:76px;height:39px;line-height:18px;text-align:center;vertical-align:middle;'><nobr>$sl3</nobr></td>";
		echo "<td class='cs8556A6FD' style='width:76px;height:39px;line-height:18px;text-align:center;vertical-align:middle;'><nobr>$sl4</nobr></td>";
		echo "<td class='cs8556A6FD' style='width:57px;height:39px;'></td>";
		echo "<td></td>";
	echo "</tr>";
	}
	...
	echo "<tr style='vertical-align:top;'>";
		...
		echo "<td class='cs16D304E1' colspan='2' style='width:76px;height:23px;line-height:18px;text-align:center;vertical-align:middle;'><nobr>$Tsl1</nobr></td>";
		echo "<td class='cs16D304E1' style='width:75px;height:23px;line-height:18px;text-align:center;vertical-align:middle;'><nobr>$Tsl2</nobr></td>";
		echo "<td class='cs16D304E1' style='width:76px;height:23px;line-height:18px;text-align:center;vertical-align:middle;'><nobr>$Tsl3</nobr></td>";
		echo "<td class='cs16D304E1' style='width:76px;height:23px;line-height:18px;text-align:center;vertical-align:middle;'><nobr>$Tsl4</nobr></td>";
