...
?>
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
			...
			<td style="text-align: center; font-weight: bold;"><nobr>Mẫu số 01a/TH/MSTT</nobr></td>
        </tr>
		<tr>
			<td style="text-align: left;font-weight: bold;">
		...
		<tr>
			<td style="text-align: left;font-weight: bold;"><nobr>ĐƠN VỊ MUA SẮM TẬP TRUNG</nobr> </td>
			<td style="text-align: center;" colspan="2"><nobr>CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</nobr></td>
		</tr>
		<tr>
			<td style="text-align: left;font-weight: bold;" ><nobr>CỦA BỘ, NGÀNH, ĐỊA PHƯƠNG: <?php echo $tendv;?></nobr> </td>
			<td style="text-align: center;" colspan="2" ><nobr>Độc lập - Tự do - Hạnh phúc</nobr></td>
		</tr>
		</table>
</br>
		<table cellspacing="0" cellpadding="0" border="0">
		<tr>
            <td  style="text-align: center;font-weight: bold;">BẢNG TỔNG HỢP NHU CẦU MUA SẮM TẬP TRUNG CỦA BỘ, NGÀNH, ĐỊA PHƯƠNG <?php echo $tendv;?></td>
		</tr>
		<tr>
...
//
	$cs = 0;
	$cc = array();
	$sql = "Select tendv,donvitinh,Sum(soluong) as SL, Sum(sotien) as ST,nguonvon,phuongthuctt,diadiem,dexuat,ghichu from tbltrangcap WHERE tentaisan = '$_r[0]'" .
		($tungay == "" ? "" : " and ngaythang >= '" . doingay($tungay) . "'") . ($denngay == "" ? "" : " and ngaythang <= '" . doingay($denngay) . "'")
		. " Group by tendv";
