...
<body>
	...
	<table cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			...
			<td style="text-align: center; font-style: italic;">(Ban hành kèm theo Thông tư số 39/2021/TT-BTC ngày 01 tháng 06 năm 2021 của Bộ trưởng Bộ Tài chính)</td>
		</tr>
	...
	<table cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			<td style="text-align: center;font-weight: bold;">Về việc cung cấp thông tin tài chính năm <?php echo $nam  ?></td>
		</tr>
		<tr>
	...
	<table cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;">
		<thead>
			...
			<tr>
				...
				<td>Số đầu năm (tại ngày 01/01/<?php echo $nam; ?>)</td>
				<td></td>
				<td><?php echo 0; ?></td>
				<td><?php echo 0; ?></td>
				<td><?php echo 0; ?></td>
			...
			<tr>
				<td style="text-align: center;">-</td>
				<td>Số cuối năm (tại ngày 01/01/<?php echo $nam; ?>)</td>
				<td></td>
				<td><?php echo 0; ?></td>
				<td><?php echo 0; ?></td>
				<td><?php echo 0; ?></td>
