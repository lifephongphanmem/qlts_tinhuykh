...
?>
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
			...
			<td style="text-align: center; font-weight: bold;"><nobr>Mẫu số B04_H</nobr></td>
        </tr>
		<tr>
			<td style="text-align: left;font-weight: bold;"><nobr><?php echo "Đơn vị báo cáo: ".$madv[2]; ?></nobr></td>
			<td>
			</td>
			<td style="text-align: center;" >(Ban hành theo QĐ 19/2006/QĐ-BTC</td>
		</tr>
		<tr>
			<td style="text-align: left;font-weight: bold;"><nobr><?php echo "Mã đơn vị: ".$masons; ?></nobr></td>
			<td>
			</td>
			<td style="text-align: center;" >ngày 30/3/2006 của Bộ trưởng Bộ Tài chính)</td>
		</tr>
		<tr>
		...
		<table cellspacing="0" cellpadding="0" border="0">
		<tr>
            <td  style="text-align: center;font-weight: bold;">BÁO CÁO TÌNH HÌNH TĂNG, GIẢM TÀI SẢN CỐ ĐỊNH</td>
		</tr>
		<tr>
	...
	<table cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;">
		<tr>
			<th rowspan="2" width="20%">- Loại TSCĐ, Nhóm TSCĐ</th>
			<th rowspan="2" >Đơn vị tính</th>
			<th colspan="2" >Số đầu năm</th>
			<th colspan="2" >Tăng trong năm</th>
			<th colspan="2" >Giảm trong năm</th>
			<th colspan="2" >Số cuối năm</th>
		</tr>
		<tr style="font-weight: bold">
			<th style="font-weight: inherit;">Số lượng</th>
			<th style="font-weight: inherit;">Giá trị</th>
			<th style="font-weight: inherit;">Số lượng</th>
			<th style="font-weight: inherit;">Giá trị</th>
			<th style="font-weight: inherit;">Số lượng</th>
			<th style="font-weight: inherit;">Giá trị</th>
...
//
	for ($i = 0; $i < $cs; $i++) {
		...
		echo "<td style='text-align: left;'> ".$dvt."</td>";
