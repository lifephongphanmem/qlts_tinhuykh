...
<table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;">
	...
	<tr style="vertical-align:top;">
		...
		<td class="csB6E29E9B" colspan="6" rowspan="2" style="width:461px;height:20px;line-height:18px;text-align:left;vertical-align:middle;"><nobr><?php echo $madv[3]; ?></nobr></td>
		<td></td>
		<td></td>
		<td class="cs550435DA" colspan="5" style="width:415px;height:19px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>Mẫu&nbsp;số&nbsp;S32&nbsp;-&nbsp;H</nobr></td>
	</tr>
	<tr style="vertical-align:top;">
		<td style="width:0px;height:1px;"></td>
		<td></td>
		<td></td>
		<td class="cs101A94F7" colspan="5" rowspan="3" style="width:415px;height:40px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>(Ban&nbsp;h&#224;nh&nbsp;theo&nbsp;QĐ&nbsp;số:&nbsp;19/2006/QĐ-BTC</nobr><br/><nobr>ng&#224;y&nbsp;30/03/2006&nbsp;của&nbsp;Bộ&nbsp;trưởng&nbsp;Bộ&nbsp;T&#224;i&nbsp;Ch&#237;nh)</nobr></td>
	</tr>
	<tr style="vertical-align:top;">
	...
	<tr style="vertical-align:top;">
		...
		<td class="csE9F2AA97" colspan="14" style="width:1097px;height:22px;line-height:18px;text-align:center;vertical-align:middle;"><nobr>SỔ&nbsp;THEO&nbsp;D&#213;I&nbsp;TSCĐ&nbsp;V&#192;&nbsp;C&#212;NG&nbsp;CỤ&nbsp;DỤNG&nbsp;CỤ&nbsp;TẠI&nbsp;NƠI&nbsp;SỬ&nbsp;DỤNG</nobr></td>
	</tr>
	<tr style="vertical-align:top;">
	<?php			
		...
		$sql = "";
		if($ckbts == "No")
			$sql = "Select ngayxuat,ttxuatdung,tenchitiet,dvt,soluong,dongia,sotien from tblxuatdung where madonvi Like '$msdv%' and chitiethinhthai like '" . $loaicc . "%' and mataisan like 'C%' and ngayxuat Between '".doingay($tungay)."' and '".doingay($denngay)."'";
		else
			$sql = "Select ngayxuat,ttxuatdung,tenchitiet,dvt,soluong,dongia,sotien from tblxuatdung where madonvi Like '$msdv%' and chitiethinhthai like '" . $loaicc . "%' and ngayxuat Between '".doingay($tungay)."' and '".doingay($denngay)."'";
		...
		if($ckbts != "No") {
			$sql = "Select ngaynhap,TTQLTS,tenchitiet,DVT,DTKV,ngansach+nguonkhac as dongia from tblxuatdung where madonvi Like '$msdv%' and chitiethinhthai like '" . $loaicc . "%' and ngayxuat Between '" . doingay($tungay) . "' and '" . doingay($denngay) . "'";
			$qrsql = mysqli_query($con, $sql);
			while ($row = mysqli_fetch_array($qrsql)) {
				$ar[$c][0] = $row['ngaynhap'];
				$ar[$c][1] = $row['ttxuatdung'];
		...
		if($ckbts == "No")		
			$sql = "Select ngaythang,tenchitiet,TTbaohong,Lydohong,soluong,dongia,sotien,dvt from tblbaohong where madonvi Like '$msdv%' and chitiethinhthai = '" . $loaicc . "' and mataisan like 'C%' and ngaythang Between '".doingay($tungay)."' and '".doingay($denngay)."'";
		else
			$sql = "Select ngaythang,tenchitiet,TTbaohong,Lydohong,soluong,dongia,sotien,dvt from tblbaohong where madonvi Like '$msdv%' and chitiethinhthai = '" . $loaicc . "' and ngaythang Between '".doingay($tungay)."' and '".doingay($denngay)."'";
		$qrsql = mysqli_query($con,$sql);
		while ($row = mysqli_fetch_array($qrsql))		
		{
	...
	<tr style="vertical-align:top;">
		<td style="width:0px;height:20px;"></td>
		<td class="cs61FA619A" rowspan="3" style="width:75px;height:20px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>Ng&#224;y,&nbsp;th&#225;ng</nobr><br/><nobr>ghi&nbsp;sổ</nobr></td>
		<td class="csAB3AA82A" colspan="7" style="width:556px;height:20px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>Ghi&nbsp;tăng&nbsp;TSCĐ&nbsp;v&#224;&nbsp;c&#244;ng&nbsp;cụ,&nbsp;dụng&nbsp;cụ</nobr></td>
		<td class="csAB3AA82A" colspan="6" style="width:466px;height:20px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>Ghi&nbsp;giảm&nbsp;TSCĐ&nbsp;v&#224;&nbsp;c&#244;ng&nbsp;cụ,&nbsp;dụng&nbsp;cụ</nobr></td>
	</tr>
	<tr style="vertical-align:middle;">
		...
		<td class="csD3053F26" rowspan="2" style="width:143px;height:20px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>T&#234;n&nbsp;dụng&nbsp;cụ&nbsp;l&#226;u&nbsp;bền</nobr></td>
		<td class="csD3053F26" rowspan="2" style="width:52px;height:20px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>Đơn&nbsp;vị</nobr><br/><nobr>t&#237;nh</nobr></td>
		<td class="csD3053F26" rowspan="2" style="width:57px;height:20px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>Số&nbsp;lượng</nobr></td>
		<td class="csD3053F26" rowspan="2" style="width:76px;height:20px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>Đơn&nbsp;gi&#225;</nobr></td>
		<td class="csD3053F26" rowspan="2" style="width:95px;height:20px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>&nbsp;Th&#224;nh&nbsp;tiền</nobr></td>
		<td class="cs8FC8786E" colspan="2" style="width:128px;height:20px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>Chứng&nbsp;từ</nobr></td>
		<td class="csD3053F26" rowspan="2" style="width:107px;height:20px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>L&#253;&nbsp;do</nobr></td>
		<td class="csD3053F26" rowspan="2" style="width:56px;height:20px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>Số&nbsp;lượng</nobr></td>
		<td class="csD3053F26" rowspan="2" style="width:76px;height:20px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>Đơn&nbsp;gi&#225;</nobr></td>
		<td class="csD3053F26" rowspan="2" style="width:95px;height:20px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>Th&#224;nh&nbsp;&nbsp;tiền</nobr></td>
	</tr>
	<tr style="vertical-align:top;">
		...
		<td class="cs8FC8786Ea" style="width:51px;height:18px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>Số&nbsp;hiệu</nobr></td>
		<td class="cs8FC8786Ea" style="width:76px;height:18px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>Ng&#224;y&nbsp;th&#225;ng</nobr></td>		
	</tr>
	<tr style="vertical-align:top;">
		<td style="width:0px;height:20px;"></td>
		...
		<td class="csA4A4F90C" style="width:76px;height:19px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>F</nobr></td>
		<td class="csA4A4F90C" style="width:107px;height:19px;line-height:15px;text-align:center;vertical-align:middle;"><nobr>G</nobr></td>
	...
	echo "<tr style='vertical-align:top;'>";
		...
		echo "<td class='csA4A4F90Ca' style='width:52px;height:19px;line-height:15px;text-align:center;vertical-align:middle;'><nobr>".$ar[1]."</nobr></td>";
		...
		echo "<td class='csA4A4F90Ca' style='width:51px;height:19px;line-height:15px;text-align:center;vertical-align:middle;'><nobr>".$ar[8]."</nobr></td>";
		echo "<td class='csA4A4F90Ca' style='width:76px;height:19px;line-height:15px;text-align:center;vertical-align:middle;'><nobr>".ngaythang($ar[9])."</nobr></td>";
	...
	echo "<tr style='vertical-align:top;'>";
		...
		echo "<td class='cs8FC8786E' style='width:76px;height:18px;'></td>";
		echo "<td class='cs8FC8786E' style='width:107px;height:18px;'></td>";
