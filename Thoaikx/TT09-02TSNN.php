...
<table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:1089px;height:539px;">
	...
	<tr style="vertical-align:top;">
		...
		<td colspan="5"></td>
		<td class="csB6E29E9B" colspan="7" style="width:388px;height:20px;line-height:18px;text-align:center;vertical-align:middle;"><nobr>Mẫu&nbsp;số&nbsp;02-DM/TSNN</nobr></td>
	</tr>
	<tr style="vertical-align:top;">
		<td style="width:0px;height:20px;"></td>
	...
	<tr style="vertical-align:top;">
		...
		<td class="csB6E29E9B" colspan="9" style="width:311px;height:21px;line-height:18px;text-align:left;vertical-align:middle;"><nobr></nobr></td>
		<td colspan="12"></td>
	</tr>
	<tr style="vertical-align:top;">
		<td style="width:0px;height:20px;"></td>
		...
		<td class="csB6E29E9B" colspan="9" style="width:311px;height:20px;line-height:18px;text-align:left;vertical-align:middle;"><nobr></nobr></td>
		<td colspan="12"></td>
	</tr>
	<tr style="vertical-align:top;">
	...
	<tr style="vertical-align:top;">
		...
		<td class="csE5855143" colspan="24" style="width:1085px;height:27px;line-height:24px;text-align:center;vertical-align:middle;"><nobr>DANH MỤC XE Ô TÔ ĐỀ NGHỊ XỬ LÝ</nobr></td>
	</tr>
	<tr style="vertical-align:top;">
...
//
	...
	$_sQLdv="Select distinct thongtindonvi.madonvi, thongtindonvi.tendv from tblqlts inner join thongtindonvi on tblqlts.madonvi=thongtindonvi.madonvi where tblqlts.madonvi Like '$msdv%' and tblqlts.chitiethinhthai Like 'Phương tiện vận tải%' and ngaysudung <= '" . doingay($denngay) . "'";
	...
	foreach($_aDV as $_madv){
		...
		echo"</tr>";
		//Kết thúc tên đơn vị
		$tnNS=0;$tnK=0;$tgtcl=0;$tqlnn=0;$tkd=0;$tkkd=0;$thdk=0;
		$sqlts = "Select tblqlts.* From tbldenghi INNER JOIN tblqlts ON tbldenghi.TTQLTS = tblqlts.TTQLTS Where tblqlts.madonvi Like '$msdv%' and tblqlts.chitiethinhthai Like 'Phương tiện vận tải%' and ngaysudung <= '" . doingay($denngay) . "'";
		...
		while($rowts = mysqli_fetch_array($queryts)){
			...
			while($rowdht = mysqli_fetch_array($queryht)){
				if($rowdht['phanloai'] === 'QLNN'){
					$qlnn = $rowdht['soluong'];
					$tqlnn = $tqlnn + $rowdht['soluong'];
				}
				if($rowdht['phanloai'] === 'Kinh doanh'){
					$kd = $rowdht['soluong'];
					$tkd = $tkd + $rowdht['soluong'];
				}
				if($rowdht['phanloai'] === 'Không KD'){
					$kkd = $rowdht['soluong'];
					$tkkd = $tkkd + $rowdht['soluong'];
				}
				if($rowdht['phanloai'] === 'Khác'){
					$hdk = $rowdht['soluong'];
					$thdk = $thdk + $rowdht['soluong'];
				}
			}
			//Còn lại 
			$cl = 0 ;
...
?>
	...
	<tr style="vertical-align:top;">
		<td style="width:0px;height:20px;"></td>
		<td class="csB6E29E9B" colspan="14" style="width:544px;height:20px;line-height:18px;text-align:center;vertical-align:middle;"><nobr></nobr></td>
	...
	<tr style="vertical-align:top;">
		<td style="width:0px;height:20px;"></td>
		<td class="cs77A39B34" colspan="14" style="width:544px;height:20px;line-height:18px;text-align:center;vertical-align:middle;"><nobr></nobr></td>
	...
	<tr style="vertical-align:top;">
		...
		<td class="csB6E29E9B" colspan="10" style="width:545px;height:100px;text-align:center;vertical-align:bottom;"><?php echo $madv[6]; ?></td>
	</tr>
	<tr style="vertical-align:top;">
