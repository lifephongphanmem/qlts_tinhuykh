...
?>
    <table cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			<td style="text-align: center;font-weight: bold; font-style: italic;">Phần 1: Tổng hợp chung </td>
		</tr>
			<tr>
				<td style="font-style: italic; text-align: right">ĐVT cho: Số lượng là: Cái, khuôn viên; Diện tích là: m2; Nguyên giá là: Nghìn đồng.</td>
			</tr>
	</table>
...
function tinhtoan($msts,$condition,$condition1,$tanggiam)
{
	...
	$sqlts = "Select distinct tblqlts.TTQLTS,tblqlts.tenchitiet,tblqlts.DVT,tblqlts.DTKV,tblqlts.DTXD,tblqlts.chitiethinhthai,ngansach+nguonkhac as NG,tblqlts.ngaysudung
					...
					where noidung like '$noidung%' and tblqlts.madonvi LIKE '$msdv%'";
	if ($phanloai == "") {
