...
?>
    <table cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			...
			<tr>
				<td colspan="14" style="font-style: italic; text-align: right">ĐVT cho: Số lượng là: Cái, khuôn viên; Diện tích là: m2; Nguyên giá là: Nghìn đồng.</td>
			</tr>
	</table>
...
//
		for ($i = 0; $i < $cs; $i++) {
			...
			if ($sl1 > 0) echo($tennhom == 'Quyền sử dụng đất' ? '1' : $tennhom == 'Nhà' ? '1' : $tennhom == 'Phương tiện vận tải đường bộ' ? '1' : $sl1);
			echo "</td>";
			...
			echo "<td style='text-align: right;'>";
			if ($sl3 > 0) echo($tennhom == 'Quyền sử dụng đất' ? '1' : $tennhom == 'Nhà' ? '1' : $tennhom == 'Phương tiện vận tải đường bộ' ? '1' : $sl3);
			echo "</td>";
			...
			echo "<td style='text-align: right;'>";
			if ($sl5 > 0) echo($tennhom == 'Quyền sử dụng đất' ? '1' : $tennhom == 'Nhà' ? '1' : $tennhom == 'Phương tiện vận tải đường bộ' ? '1' : $sl5);
			echo "</td>";
			...
			echo "<td style='text-align: right;'>";
			if ($sl7 > 0) echo($tennhom == 'Quyền sử dụng đất' ? '1' : $tennhom == 'Nhà' ? '1' : $tennhom == 'Phương tiện vận tải đường bộ' ? '1' : $sl7);
			echo "</td>";
