		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" style="text-align:center;"><strong>Bảng tính hao mòn tài sản cố định</strong></h4>
				</div>
				...
				<form name="thoai" role="form" method="Post" class="form-horizontal" onsubmit="return kt()">
					...
					<input name="nambc" type="text" id="nambc" class="form-control">
					</div>
					</div>
...
function kt()
{
	//window.document.thoai.action = "/Tienich/BaHMTSCDexcel.php";
   ...
   {
	  //if (frm.ccdc.value == true)
		  //frm.action = "/Tienich/BaHMTSCDexcel.php";
	  //else
		  //frm.action = "BaHMTSCD.php";
      return true;    
   }
}
</script>
<script type="text/javascript">
    ...
    function get_action() {		
		if ($("input[name='ccdc']:checked").length == 1)
			return "/Tienich/BaHMTSCDexcel.php";
		else
			return "BaHMTSCD.php";			
    }
</script>
