   ...
   if(giatri == "")
	...
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Bảng tổng hợp chi tiết công cụ dụng cụ</strong></h4>
		</div>
			<div class="modal-body">
					<form name="thoai"  role="form" method="Post" class="form-horizontal" action="BaTHCTCCDC.php">
...
<script type="text/javascript">
	...
	function get_action() {
		if ($("input[name='ccdc']:checked").length == 1)
			return "/Tienich/BaTHCTCCDCexcel.php";
		else
			return "BaTHCTCCDC.php";
	}
</script>
<!----------- Footer ------------->
</div>
