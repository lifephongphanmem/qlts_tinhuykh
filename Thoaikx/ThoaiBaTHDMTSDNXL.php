...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Tổng hợp tài sản đề nghị xử lý</strong></h4>
		</div>
			<div class="modal-body">
				<form name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" action="BaTHDMTSDNXL.php">
...
<script type="text/javascript">
    ...
    function get_action() {		
		if ($("input[name='ccdc']:checked").length == 1)
			return "/Tienich/BaTHDMTSDNXLexcel.php";
		else
			return "BaTHDMTSDNXL.php";			
    }
</script>
<!----------- Footer ------------->
</div>
