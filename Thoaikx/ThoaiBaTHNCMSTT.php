...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Tổng hợp tài sản đề nghị trang cấp</strong></h4>
		</div>
			<div class="modal-body">
				<form name="thoai" role="form" onsubmit="return kt()" method="Post" class="form-horizontal" action="BaTHNCMSTT.php">
...
<script type="text/javascript">
    ...
    function get_action() {		
		if ($("input[name='ccdc']:checked").length == 1)
			return "/Tienich/BcTHDSTSDNTCexcel.php";
		else
			return "BaTHNCMSTTb.php";
    }
</script>
<!----------- Footer ------------->
</div>
