...
<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" style="text-align:center;"><strong>Báo cáo kiểm kê tài sản</strong></h4>
				</div>
				<div class="modal-body">
					<form name="thoai" role="form" method="Post" class="form-horizontal" onsubmit="return kt()" action="Baocaokktscd.php">
					...
					?>
							...
							<div class="form-group">
								...
								<div class="col-sm-12"><label>Tính đến ngày: </label><input data-inputmask="'alias': 'date'" name="nttu" class="form-control"  type="text"></div>
							</div>
							<div class="form-group">	
...
<script type="text/javascript">
    ...
    function get_action() {		
		if ($("input[name='ccdc']:checked").length == 1)
			return "/Tienich/Baocaokktscdexcel.php";
		else
			return "Baocaokktscd.php";			
    }
</script>
<!----------- Footer ------------->
</div>
