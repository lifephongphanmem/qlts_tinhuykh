...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Báo cáo tăng giảm tài sản</strong></h4>
		</div>
			<div class="modal-body">
				<form name="thoai" role="form" method="Post" class="form-horizontal" onsubmit="return kt()" action="BcTHTGTSCDdv.php">
				<div class="form-group" <?php if (strlen($ma[0]) >= 16){echo "style='display:none';";}?>>
					...
					<div class="form-group" <?php if (strlen($ma[0]) < 16){echo "style='display:none';";}?>>
						<div class="col-sm-12" <?php if (strlen($ma[0]) < 16){echo "style='display:none';";}?>><label>Nơi sử dụng:</label>
				...
				<input type="checkbox" name="tgsc" id = "tgsc"/>
					Bao gồm cả tăng giảm, sửa chữa
					<div class="col-sm-8">
