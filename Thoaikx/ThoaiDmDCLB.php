...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Danh mục công cụ dụng cụ</strong></h4>
		</div>
			<div class="modal-body">
					<form name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" action="DmDCLB.php">
					...
					?>
					 ...
					 <div class="form-group">
						<div class="col-sm-12"><label>Bộ phận sử dụng: </label><select  name="phanloai" class="form-control"  type="text">	
						<option value=""></option>
						<?php	
						require("$_SERVER[DOCUMENT_ROOT]/Main/connect.php");
						$sqlpl = "Select tenphongban from tblphongban where madonvi = '$ma[0]' group by tenphongban";
						$querypl=mysqli_query($con,$sqlpl);
						while($rowpl=mysqli_fetch_array($querypl))		
						{						
							$ten=$rowpl['tenphongban'];	
...
<script type="text/javascript">
	...
	function get_action() {
		if ($("input[name='ccdc']:checked").length == 1)
			return "/Tienich/DmDCLBexcel.php";
		else
			return "DmDCLB.php";
	}
</script>
