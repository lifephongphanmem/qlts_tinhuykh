...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>	Giấy báo hỏng, mất công cụ, dụng cụ</strong></h4>
		</div>
			<div class="modal-body">
					<form name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" action="SoBaohong.php">
					<div class="form-group" <?php if (strlen($ma[0]) >= 16){echo "style='display:none';";}?>>
								<div class="col-sm-12"><label>Đơn vị:</label><select  name="donvi" class="form-control"  type="text">	
								<option value=""></option>
								<?php	
	...
	<script type="text/javascript">
		...
		function get_action() {
			if ($("input[name='ccdc']:checked").length == 1)
				return "/Tienich/SoBaoHongexcel.php";
			else
				return "SoBaohong.php";
		}
	</script>
<!----------- Footer ------------->
</div>
