		...
		<div class="modal-header">
			...
			<div class="modal-body">
					...
					<div class="form-group" style="display: none;">
						...
						<div class="col-sm-12"><label>Tên công cụ: </label><select name="tencc" class="form-control" type = "text">
						<option value=""></option>
						<?php		
...
function kt()
{
   ...
   if(frm.tencc.value=='')
   {
      alert('Xin vui lòng chọn tên công cụ muốn tạo báo cáo !');
	...
	<script type="text/javascript">
		...
		function get_action() {
			if ($("input[name='ccdc']:checked").length == 1)
				return "/Tienich/SoCTCCDCexcel.php";
			else
				return "SoCTCCDC.php";
		}
	</script>
