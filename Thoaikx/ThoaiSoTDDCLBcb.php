...
<script src="/assets/News/jquery.min.js" xmlns="http://www.w3.org/1999/html"></script>
...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Sổ chi tiết dụng cụ lâu bền</strong></h4>
		</div>
			<div class="modal-body">
					<form name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" action="SoTDTSCCDC.php">
					...
					?>
						...
						<div class="form-group">
							...
							<div class="form-group">
							<div class="col-sm-12"><label>Loại công cụ lâu bền: </label><select name="loaicc" class="form-control" type = "text">
							<option value=""></option>
							<?php		
						...
						<input type="checkbox" name="ts" value="Yes" />
						Tổng hợp bao gồm cả tài sản
						</br>
						<input type="checkbox" name="ccdc" id = "ccdc"/>
						Xuất dữ liệu ra file excel
						<!--div class="form-group">
							<div class="col-sm-12"><label>Từ ngày: </label><input data-inputmask="'alias': 'date'" name="nttu" class="form-control"  type="text"></div>
						</div>
						<div class="form-group">
							<div class="col-sm-12"><label>Đến ngày: </label><input data-inputmask="'alias': 'date'" name="ntden" class="form-control"  type="text"></div>
						</div-->
						<div class="form-group">	
						<div class="col-sm-8">
...
function kt()
{
   ...
   //if(frm.loaicc.value=='')
   //{
   //   alert('Xin vui lòng chọn loại công cụ !');
   //   document.forms['thoai'].loaicc.focus();
   //   return false;
   //}
   //else if(frm.noisudung.value=='')
   //{
   //   alert('Xin vui lòng chọn nơi sử dụng !');
   //   document.forms['thoai'].noisudung.focus();
   //   return false;
   //}
   //else
      return true;    
	...
	<script type="text/javascript">
		...
		function get_action() {
			if ($("input[name='ccdc']:checked").length == 1)
				return "/Tienich/SoTDDCLBexcel.php";
			else
				return "SoTDTSCCDC.php";
		}
	</script>
 <!----------- Footer ------------->
</div>
