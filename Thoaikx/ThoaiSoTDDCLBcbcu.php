	...
	<div class="modal-content">
		<div class="modal-header">
			...
			<div class="modal-body">
					<form name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" action="SoTDDCLBcb.php">
   ...
   else if(frm.ntden.value=='')
   {
	...
	function get_action() {
		if ($("input[name='ccdc']:checked").length == 1)
			return "/Tienich/SoTDDCLBcbexcel.php";
		else
			return "SoTDDCLBcb.php";
	}
	</script>
<!----------- Footer ------------->
</div>
