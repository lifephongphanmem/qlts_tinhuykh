	...
	<div class="modal-content">
		<div class="modal-header">
			...
			<div class="modal-body">
				<form name="thoai" onsubmit=" return kt()" role="form" method="Post" class="form-horizontal" action="SoTSCD.php">
				...
				<div>
					<input type="checkbox" name="hmtd" value="Yes" />
					Không tự động tính hao mòn
					</br>
					<input type="checkbox" name="hmht" value="Yes" />
					Không tính hao mòn năm hiện tại
					</br>
...
<script type="text/javascript">
    ...
    function get_action() {		
		if ($("input[name='fileexcel']:checked").length == 1)
			return "/Tienich/SoTSCDexcel.php";
		else
			return "SoTSCD.php";
    }
</script>
