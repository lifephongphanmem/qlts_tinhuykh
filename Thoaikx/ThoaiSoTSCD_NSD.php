		...
		<div class="modal-header">
			...
			<div class="modal-body">
				...
				<div class="form-group" <?php if (strlen($ma[0]) >= 16){echo "style='display:none';";}?>>
					...
					<div class="form-group" <?php if (strlen($ma[0]) < 16){echo "style='display:none';";}?>>
						<div class="col-sm-12" <?php if (strlen($ma[0]) < 16){echo "style='display:none';";}?>><label>Người sử dụng:</label>
							<select  name="nguoisudung" class="form-control" id="nguoisudung"  type="text">
								<option value="">-- Chọn người sử dụng --</option>
								<?php
								require("$_SERVER[DOCUMENT_ROOT]/Main/connect.php");
								$sqldv = "Select DISTINCT nguoisudung from tblqlts where madonvi = '$ms[0]' ";
								$querydv=mysqli_query($con,$sqldv);
								while($rowdv=mysqli_fetch_array($querydv))
								{
