	...
	$('#xa').load('ajax_xa.php?id='+giatri);	
		...
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" style="text-align:center;"><strong>Báo cái kê khai trụ sở làm việc, cơ sở hoạt động sự nghiệp</strong></h4>
			</div>
				<div class="modal-body">
					...
					?>
						 ...
						 <div class="form-group">
							<div class="col-sm-12"><label>Địa chỉ: </label><select  name="phanloai" class="form-control"  type="text">	
							<option value=""></option>
							<?php	
							require("$_SERVER[DOCUMENT_ROOT]/Main/connect.php");
							$sqlpl = "Select distinct TKVDAT from tblqlts Where (chitiethinhthai Like 'Quyền sử dụng đất%' or chitiethinhthai Like 'Đất%') and madonvi like '$ma[0]%'";
						...
						<div class="form-group">
							<div class="col-sm-12"><label>Ngày tháng từ: </label><input data-inputmask="'alias': 'date'" name="nttu" class="form-control"  type="text" ></div>
						</div>
						<div class="form-group">
							<div class="col-sm-12"><label>Ngày tháng đến: </label><input data-inputmask="'alias': 'date'" name="ntden" class="form-control"  type="text"></div>
						</div>	
						<div class="form-group">
							<input class="col-sm-1" type="radio" name="option" value="Báo cáo kê khai lần đầu"> Báo cáo kê khai lần đầu<br>
						</div>
						<div class="form-group">
							<input class="col-sm-1" type="radio" name="option" value="Báo cáo kê khai bổ xung"> Báo cáo kê khai bổ xung<br>
						</div>
						<div class="form-group">	
						<div class="col-sm-8">
...
function kt()
{
   ...
   if(frm.nttu.value=='')
   {
      alert('Xin vui lòng nhập ngày tháng từ !');            
      document.forms['thoai'].nttu.focus();
      return false;
   }
   else if(frm.ntden.value=='')
   {
      alert('Xin vui lòng nhập ngày tháng đến !');
      document.forms['thoai'].ntden.focus();            
      return false;
   }
     else if(frm.option.value=='')
   {
      alert('Xin vui lòng nhập loại báo cáo kê khai !');        
      return false;
   }
   else                        
      return true;    
	...
	<script type="text/javascript">
		...
		function get_action() {
			if ($("input[name='ccdc']:checked").length == 1)
				return "/Tienich/TT09_01DKTSNNexcel.php";
			else
				return "TT09_01DKTSNN.php";
		}
	</script>
<!----------- Footer ------------->
</div>
