		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="modal-body">
								<form  name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" action="TT09_01TSNN.php">
					...
					?>
									...
									<?php	
									require("$_SERVER[DOCUMENT_ROOT]/Main/connect.php");
									$sqlpl = "Select TKVDAT from tblqlts Where (chitiethinhthai Like 'Quyền sử dụng đất%' or chitiethinhthai Like 'Đất%') and madonvi like '$ma[0]%' group by TKVDAT";
...
<script type="text/javascript">
    ...
    function get_action() {		
		if ($("input[name='ccdc']:checked").length == 1)
			return "/Tienich/TT09_01TSNNexcel.php";
		else
			return "TT09_01TSNN.php";			
    }
</script>
<!----------- Footer ------------->
</div>
