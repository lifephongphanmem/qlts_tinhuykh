	...
	$('#xa').load('ajax_xa.php?id='+giatri);	
		...
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" style="text-align:center;"><strong>Báo cái kê khai ô tô</strong></h4>
			</div>
				<div class="modal-body">
						<form name="thoai" role="form" method="Post" class="form-horizontal" onsubmit="return kt()" action="TT09_02DKTSNN.php">
					...
					?>
							...
							<div class="form-group">
								<input class="col-sm-1" type="radio" name="option" value="Báo cáo kê khai lần đầu"> Báo cáo kê khai lần đầu
							</div>
							<div class="form-group">
								<input class="col-sm-1" type="radio" name="option" value="Báo cáo kê khai bổ xung"> Báo cáo kê khai bổ xung
							</div>
							<div class="form-group">	
...
<script type="text/javascript">
    ...
    function get_action() {		
		if ($("input[name='ccdc']:checked").length == 1)
			return "/Tienich/TT09_02DKTSNNexcel1.php";
		else
			return "TT09_02DKTSNN.php";			
    }
</script>
<!----------- Footer ------------->
</div>
