...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Báo cáo kê khai tài sản có nguyên giá hơn 500 triệu</strong></h4>
		</div>
			<div class="modal-body">
  <form name="thoai" onsubmit="return kt()"  role="form" method="Post" class="form-horizontal" action="TT09_03DKTSNN.php"> 
	...
	<div>
		<input type="checkbox" name="ld" value="Yes" />
		Báo cáo kê khai lần đầu   
	</div>	
	<div>
		<input type="checkbox" name="bs" value="Yes" />
...
<script type="text/javascript">
    ...
    function get_action() {		
		if ($("input[name='ccdc']:checked").length == 1)
			return "/Tienich/TT09_03DKTSNNexcel.php";
		else
			return "TT09_03DKTSNN.php";			
    }
</script>
<!----------- Footer ------------->
</div>
