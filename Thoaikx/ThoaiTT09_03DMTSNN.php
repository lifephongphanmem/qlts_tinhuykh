...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Danh mục tài sản khác đề nghị xử lý</strong></h4>
		</div>
			<div class="modal-body">
					  <form name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" action="TT09_03SNN.php">
...
<script type="text/javascript">
    ...
    function get_action() {		
		if ($("input[name='ccdc']:checked").length == 1)
			return "/Tienich/TT09_03SNNexcel.php";
		else
			return "TT09_03DMTSNN.php";
    }
</script>
<!----------- Footer ------------->
</div>
