  ...
  <div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Báo cáo kê khai thay đổi thông tin về đơn vị sử dụng tài sản</strong></h4>
		</div>
			<div class="modal-body">
  <form name="thoai" onsubmit="return kt()"  role="form" method="Post" class="form-horizontal" action="TT09_04aDKTSNN.php"> 
	<div class="form-group" <?php if (strlen($ma[0]) >= 16){echo "style='display:none';";}?>>
									...
									$sqldv = "Select madonvi,tendv from thongtindonvi";
