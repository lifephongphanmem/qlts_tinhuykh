...
<div class="container" id="container">
  <form role="form" method="Post" class="form-horizontal" action="TT09_04dDKTSNN.php">
		<?php
   	...
   	<div class="form-group">
		...
		<option value=""></option>
		<?php			
			$sql = "Select tenchitiet FROM tblqlts INNER JOIN tblthaydoi ON tblqlts.TTQLTS = tblthaydoi.ttts Where (chitiethinhthai Not like 'Quyền sử dụng đất%' or chitiethinhthai Not like 'Đất%' or chitiethinhthai Not like 'Nhà%' or chitiethinhthai Not like 'Phương tiện vận tải đường bộ%') and cdbl(ngansach) + cdbl(nguonkhac) >= 500000000";
