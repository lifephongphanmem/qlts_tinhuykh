...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Báo cáo hiện trạng sử dụng tài sản công</strong></h4>
		</div>
  ...
  <form name="thoai" onsubmit="return kt()"  role="form" method="Post" class="form-horizontal" >
    ...
    <div class="form-group">
		<div class="col-sm-12"><label>Ngày báo cáo: </label><input data-inputmask="'alias': 'date'" name="ngaythang" class="form-control"  type="text"></div>
	</div>
	  <div class="form-group">
...
function kt()
{
   ...
   if(frm.ngaythang.value=='')
   {
      alert('Xin vui lòng nhập ngày tháng !');
      document.forms['thoai'].ngaythang.focus();
      return false;
   }
    ...
    function get_action() {
		if ($('#phanloai').val() == "P1") {
			if ($("input[name='ccdc']:checked").length == 1)
				return "/Tienich/TT144_08aP1.php";
			else
				return "TT144_08aP1.php";
		}
		else if($('#phanloai').val() == "P2") {
			if ($("input[name='ccdc']:checked").length == 1)
				return "/Tienich/TT144_08aP2.php";
			else
				return "TT144_08aP2.php";
		}
		else if($('#phanloai').val() == "P3")
		{
			if ($("input[name='ccdc']:checked").length == 1)
				return "/Tienich/TT144_08aP3.php";
			else
				return "TT144_08aP3.php";
		}
	}
</script>
<!----------- Footer ------------->
