...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Báo cáo tổng hợp tình hình tăng giảm</strong></h4>
		</div>
  ...
  <form name="thoai" onsubmit="return kt()"  role="form" method="Post" class="form-horizontal" >
	<div class="form-group" <?php if (strlen($ma[0]) >= 16){echo "style='display:none';";}?>>
	  ...
	  <div class="form-group">
		  <label class="col-sm-12 control-label">Phân loại báo cáo:</label>
		  <div class="col-sm-12">
			  <select name='phanloai' class='form-control' id = "phanloai">
				  <option selected='selected' value='P1'>Phần 1: Tổng hợp chung</option>
				  <option  value='P2'>Phần 2. Chi tiết theo loại hình đơn vị</option>
				  <option  value='P3'>Phần 3. Chi tiết theo từng đơn vị</option>
			  </select>
		  </div>
	  </div>
	  <div class="form-group">
...
function kt()
{
   ...
   if(frm.nttu.value=='')
   {
      alert('Xin vui lòng nhập ngày tháng !');
   ...
   else if(frm.phanloai.value=='')
   {
      alert('Xin vui lòng nhập ngày tháng đến !');
      document.forms['thoai'].phanloai.focus();
      return false;
   }
   else                        
      return true;    
    ...
    function get_action() {
		if ($('#phanloai').val() == "P1") {
			if ($("input[name='ccdc']:checked").length == 1)
				return "/Tienich/TT144_08bP1.php";
			else
				return "TT144_08bP1.php";
		}
		else if($('#phanloai').val() == "P2") {
			if ($("input[name='ccdc']:checked").length == 1)
				return "/Tienich/TT144_08bP2.php";
			else
				return "TT144_08bP2.php";
		}
		else if($('#phanloai').val() == "P3")
		{
			if ($("input[name='ccdc']:checked").length == 1)
				return "/Tienich/TT144_08bP3.php";
			else
				return "TT144_08bP3.php";
		}
	}
</script>
<!----------- Footer ------------->
