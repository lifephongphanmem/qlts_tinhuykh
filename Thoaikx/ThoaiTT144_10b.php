...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Báo cáo công khai tình hình quản lý, sử dụng tài sản công</strong></h4>
		</div>
	...
	<div class="form-group" <?php if (strlen($ma[0]) >= 16){echo "style='display:none';";}?>>
	  ...
	  <div class="form-group">
		  <div class="col-sm-12"><label>Năm báo cáo: </label>
			  <input name="nambc" type="text" id="nambc" class="form-control" value="<?php $now = getdate(); echo $now['year'];?>">
		  </div>
		  </div>
	  <div class="form-group">
	  <div>
...
<script type="text/javascript">
    ...
    function get_action() {
		if ($("input[name='ccdc']:checked").length == 1)
			return "/Tienich/TT144_10b.php";
		else
			return "TT144_10b.php";
	}
</script>
<!----------- Footer ------------->
</div>
