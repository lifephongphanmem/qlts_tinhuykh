...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Báo cáo công khai tình hình xử lý tài sản công</strong></h4>
		</div>
...
<script type="text/javascript">
    ...
    function get_action() {
		if ($("input[name='ccdc']:checked").length == 1)
			return "/Tienich/TT144_10c.php";
		else
			return "TT144_10c.php";
	}
</script>
<!----------- Footer ------------->
</div>
