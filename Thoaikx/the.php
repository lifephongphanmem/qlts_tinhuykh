			...
			<div class="col-md-12">
				<div class="panel panel-primary" data-collapsed="0">	
					...
					<div class="form-group">
								<b style="font-size: 20px;">Thẻ tài sản cố định</b>
					</div>
						<div class="table-responsive">
							<form method="POST">
									...
									<tbody>
											...
											$sql = "select TTQLTS,mataisan,tentaisan,tenchitiet, phantram from tblqlts  where madonvi like '$ma[0]%' and XOA <> 'TL' and XOA <> 'DC' and XOA <> 'Bán' ";
											...
											if(mysqli_num_rows($kq)>0){												
												...
												$idchuyen = $madv.">".$row[0];
														echo"<tr>";
															...
															echo"<td>$row[4]</td>";
															echo"<td>
																	<a href=\"TheTSCD245.php?id=$idchuyen\" class='btn btn-green'>Chọn</a>																					
																</td>";
														echo"</tr>";
												 }}         
											 ?> 
		...
		<div class="modal-dialog">
			<div class="modal-content">				
				<div class="modal-header">
					...
					<h4 class="modal-title" style="text-align:center;"><strong>Tạo thẻ tài sản cố định</strong></h4>
				</div>				
				<div class="modal-body">	
					<?php echo "<form role='form' method='Post' class='form-horizontal' action='TheTSCD.php?id=$madv'>";?>					
							<div class="form-group">
								<label class="col-sm-3 control-label">TT tài sản:</label>
								<div class="col-sm-8">
									<input name="bookId" readonly="false" type="text" class="form-control" id="bookId">									
								</div>								
								<label for="field-1" class="col-sm-3 control-label">Mã tài sản:</label>
								<div class="col-sm-8">
									<input name="mataisan" readonly="false" type="text" class="form-control" id="mataisan">
								</div>
								<label for="field-2" class="col-sm-3 control-label">Tên gọi tài sản:</label>
								<div class="col-sm-8">
									<input name="tentaisan" readonly="false" type="text" class="form-control" id="tentaisan">
								</div>
								<label for="field-3" class="col-sm-3 control-label">Tên gọi chi tiết:</label>
								<div class="col-sm-8">
									<input name="tenchitiet" readonly="false" type="text" class="form-control" id="tenchitiet">
								</div>
								<label for="field-4" class="col-sm-3 control-label">Hao mòn:</label>
								<div class="col-sm-8">
									<input name="phantram" readonly="false" type="text" class="form-control" id="phantram">
								</div>
								<div class="form-group">
								<label for="field-4" class="col-sm-3 control-label">Căn cứ:</label>
								<div class="col-sm-8">
									<input name="cancu"  type="text" class="form-control" id="" value = "vào biên bản giao nhận TSCĐ số ... ngày ... tháng ... năm .....">
								</div>
								</div>
								<div class="form-group">
								<label for="field-4" class="col-sm-3 control-label">Đình chỉ sử dụng TSCĐ:</label>
								<div class="col-sm-8">
									<input name="dcsd"  type="text" class="form-control" id="" value = "Ngày ... tháng ... năm .......">
								</div>							
								</div>
								<div class="form-group">
								<label for="field-4" class="col-sm-3 control-label">Lý do đình chỉ:</label>
								<div class="col-sm-8">
									<input name="lddc"  type="text" class="form-control" id="">
								</div>								
							</div>				
							</div>
							<div class="form-group">
								<button type="button" class="btn btn-info" data-dismiss="modal">Đóng</button>
								<input type="submit" name="taothe" class="btn btn-info" value = "Tạo thẻ">								
							</div>	
						</form>							
				</div>
			</div>
