...
?>
    <table cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
            ...
            <td style="text-align: center;font-weight: bold;">BÁO CÁO TĂNG TÀI SẢN NHÀ NƯỚC CỦA ĐƠN VỊ TRỰC TIẾP SỬ DỤNG</td>
			<td></td>
		</tr>
		<tr>
			<td>
...
require ("$_SERVER[DOCUMENT_ROOT]/thoaikx/general.php");
	...
	$sql = $sql." Where tblqlts.madonvi = '".$dv."' and tblqlts.ngaysudung between '".doingay($ngtu)."' and '".doingay($ngden)."'";
