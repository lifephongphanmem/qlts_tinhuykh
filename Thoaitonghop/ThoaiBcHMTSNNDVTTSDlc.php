		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="modal-body">
					<form name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" action="BcHMTSNNDVTTSDlc.php">
						...
						<div class="form-group">
							<div class="col-sm-12"><label>Năm hao mòn: </label><input name="nhaomon" class="form-control"  type="text" id = "nhaomon"></div>
						</div>	
						<div class="form-group">
