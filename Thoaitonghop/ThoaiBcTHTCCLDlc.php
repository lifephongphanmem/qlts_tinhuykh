...
<?php include("$_SERVER[DOCUMENT_ROOT]/Main/header2.php");?>
		...
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" style="text-align:center;"><strong>Báo cáo tình hình tăng công cụ lao động</strong></h4>
			</div>
				<div class="modal-body">
					<form name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" action="BcTHTCCLDlc.php">
						...
						<div class="form-group">
							<div class="col-sm-12"><label>Ngày tháng từ: </label><input data-inputmask="'alias': 'date'" name="nttu" class="form-control"  type="text" id = "nttu"></div>
						</div>
						<div class="form-group">
							<div class="col-sm-12"><label>Ngày tháng đến: </label><input data-inputmask="'alias': 'date'" name="ntden" class="form-control"  type="text" id = "ntden"></div>
						</div>
						<div class="form-group">	
						<div class="col-sm-8">
...
function kt()
{
   ...
   if(frm.nttu.value=='')
   {
      alert('Xin vui lòng nhập ngày tháng từ báo cáo!');            
   ...
   {
      alert('Xin vui lòng nhập ngày tháng đến báo cáo!');            
