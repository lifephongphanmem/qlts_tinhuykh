    ...
    $(":input").inputmask();
		...
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" style="text-align:center;"><strong>Báo cáo tổng hợp tình hình tăng, giảm tài sản nhà nước</strong></h4>
			</div>
				<div class="modal-body">
					<form name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" action="BcTHTGTSNNlc.php">
