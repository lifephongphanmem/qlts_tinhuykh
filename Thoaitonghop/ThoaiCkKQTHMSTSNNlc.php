...
<?php include("$_SERVER[DOCUMENT_ROOT]/Main/header2.php");?>
		...
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" style="text-align:center;"><strong>Công khai kết quả thực hiện mua sắm tài sản nhà nước</strong></h4>
			</div>
				<div class="modal-body">
					<form name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" action="CkKQTHMSTSNNlc.php">
					    <?php						
						if (strlen($ma[0]) >= 16)
