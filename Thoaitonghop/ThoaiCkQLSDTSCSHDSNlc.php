...
<?php include("$_SERVER[DOCUMENT_ROOT]/Main/header2.php");?>
		...
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" style="text-align:center;"><strong>Công khai quản lý, sử dụng trụ sở làm việc, CSHĐSN</strong></h4>
			</div>
				<div class="modal-body">
					<form name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" action="CkQLSDTSCSHDSNlc.php">
					    <?php						
						if (strlen($ma[0]) >= 16)
