...
<?php include("$_SERVER[DOCUMENT_ROOT]/Main/header2.php");?>
		...
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" style="text-align:center;"><strong>Công khai quản lý, sử dụng phương tiện đi lại và tài sản khác</strong></h4>
			</div>
				<div class="modal-body">
					<form name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" action="CkSDPTDLlc.php">
					    <?php						
						if (strlen($ma[0]) >= 16)
							...
							echo "<div class='col-sm-12'>";
								echo "<label>Đơn vị báo cáo: </label>";
								echo "<select  name='dv' class='form-control' id='dv'  type='text'>";
					...
					?>				 
						<div class="form-group">
							<div class="col-sm-12"><label>Năm báo cáo: </label><input name="nhaomon" class="form-control"  type="text" id = "nhaomon"></div>
						</div>
						<div class="form-group">	
						<div class="col-sm-8">
