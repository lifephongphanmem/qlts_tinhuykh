    ...
    $(":input").inputmask();
		...
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" style="text-align:center;"><strong>Tổng hợp báo cáo hiện trạng sử dụng nhà, đất</strong></h4>
			</div>
					...
					<form name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" >
						...
						<div class="form-group">
							<div class="col-sm-12">
								...
								<select  name="phanloai" class="form-control" id="phanloai"  type="text">
									<option value=""></option>
									<option value="Quyền sử dụng đất">Quyền sử dụng đất</option>
									<option value="Nhà">Nhà</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-12"><label>Ngày báo cáo: </label><input data-inputmask="'alias': 'date'" name="nttu" class="form-control"  type="text"></div>
						</div>
	...
	<script type="text/javascript">
		...
		function get_action() {
			if ($("input[name='fileexcel']:checked").length == 1)
				return "/Tienich/ThBCHTSDNDlcexcel.php";
			else
				return "ThBCHTSDNDlc.php";
		}
	</script>
<!----------- Footer ------------->
</div>
