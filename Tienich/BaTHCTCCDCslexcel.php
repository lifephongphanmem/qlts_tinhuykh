...
dulieumotcot($objPHPExcel,'C8','SỐ LƯỢNG','B','Time New Roman',10,'','','F8',40,'C');
...
taofile($objPHPExcel,"BaTHCTCCDCsl.xls","$_SERVER[DOCUMENT_ROOT]\\data\\upload","");
?>
...
<a href="download.php?id=\data\upload\BaTHCTCCDCsl.xls">Bấm vào đây để tải file về</a>
</body>