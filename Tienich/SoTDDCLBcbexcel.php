...
dulieumotcot($objPHPExcel,'I1','Mẫu số : S32-H','B','Time New Roman',10,'','','N1',0,'');
dulieumotcot($objPHPExcel,'I2','(Ban hành theo QĐ số: 19 - 2006/QĐ/BTC','','Time New Roman',10,'','','N2',0,'');
dulieumotcot($objPHPExcel,'I3','ngày 30/03/2006 của Bộ trưởng BTC)','','Time New Roman',10,'','','N3',0,'');

dulieumotcot($objPHPExcel,'A4','SỔ THEO DÕI TSCĐ VÀ CÔNG CỤ DỤNG CỤ TẠI NƠI SỬ DỤNG','B','Time New Roman',16,'','','N4',0,'');
...
dulieumotcot($objPHPExcel,'B8','Ghi tăng TSCĐ và công cụ, dụng cụ','B','Time New Roman',10,'','','H8',0,'C');
...
dulieumotcot($objPHPExcel,'I8','Ghi giảm TSCĐ và công cụ, dụng cụ','B','Time New Roman',10,'','','N8',0,'C');
...
$sql = "";
if($ckbts == "No")
	$sql = "Select ngayxuat,ttxuatdung,tenchitiet,dvt,soluong,dongia,sotien from tblxuatdung where madonvi Like '$msdv%' and chitiethinhthai = '" . $loaicc . "' and mataisan like 'C%' and ngayxuat Between '".doingay($tungay)."' and '".doingay($denngay)."'";
else
	$sql = "Select ngayxuat,ttxuatdung,tenchitiet,dvt,soluong,dongia,sotien from tblxuatdung where madonvi Like '$msdv%' and chitiethinhthai = '" . $loaicc . "' and ngayxuat Between '".doingay($tungay)."' and '".doingay($denngay)."'";
