...
dulieumotcot($objPHPExcel,'I1','Mẫu số 04a-ĐK/TSC','B','Time New Roman',11,'','','R1',0,'');

dulieumotcot($objPHPExcel,'A6','BÁO CÁO KÊ KHAI TRỤ SỞ LÀM VIỆC, CƠ SỞ HOẠT ĐỘNG SỰ NGHIỆP CỦA CƠ QUAN, TỔ CHỨC, ĐƠN VỊ','B','Time New Roman',16,'','','R6',0,'');
dulieumotcot($objPHPExcel,'A7','I - Về đất: ','B','Time New Roman',10,'T','','R7',0,'');
dulieumotcot($objPHPExcel,'A8','a - Địa chỉ: '.$dckv,'B','Time New Roman',10,'T','','R8',0,'');
dulieumotcot($objPHPExcel,'A9','b - Diện tích khuân viên đất: '.$dtkv.' m2','','Time New Roman',10,'T','','R9',0,'');
dulieumotcot($objPHPExcel,'A10','c - Hiện trạng sử dụng: '.$kq,'','Time New Roman',10,'T','','R10',0,'C');
dulieumotcot($objPHPExcel,'A11','d - Giá trị theo sổ kế toán: '.$gtskt.' Ngàn đồng','','Time New Roman',10,'T','','R11',0,'C');
dulieumotcot($objPHPExcel,'A12','II - Về nhà: ','B','Time New Roman',10,'T','','R12',0,'');
...
dulieumotcot($objPHPExcel,'F13','GIÁ TRỊ THEO SỔ KẾ TOÁN (nghìn đồng)','','Time New Roman',10,'','','H13',24,'C');
...
dulieumotcot($objPHPExcel,'R15','Sử dụng khác','','Time New Roman',10,'','','R15',8,'C');
...
$index++;
dulieumotcot($objPHPExcel,'A'.$index,'............, ngày ... tháng ... năm ......','I','Time New Roman',11,'','','H'.$index,0,'');
dulieumotcot($objPHPExcel,'I'.$index,'............, ngày ... tháng ... năm ......','I','Time New Roman',11,'','','R'.$index,0,'');
$index++;
dulieumotcot($objPHPExcel,'A'.$index,'XÁC NHẬN CỦA CƠ QUAN QUẢN LÝ CẤP TRÊN (nếu có)','B','Time New Roman',11,'','','H'.$index,0,'');
dulieumotcot($objPHPExcel,'I'.$index,'THỦ TRƯỞNG CƠ QUAN, TỔ CHỨC, ĐƠN VỊ','B','Time New Roman',11,'','','R'.$index,0,'');
$index++;
dulieumotcot($objPHPExcel,'A'.$index,'(Ký, họ tên, đóng dấu)','I','Time New Roman',11,'','','H'.$index,0,'');
dulieumotcot($objPHPExcel,'I'.$index,'(Ký, họ tên, đóng dấu)','I','Time New Roman',11,'','','R'.$index,0,'');
$index=$index+6;
if(isset($_POST['create'])){
	$abc = $_POST['option'];
}
...
//Xuất ra file Excel
taofile($objPHPExcel,"TT144_04aDKTSC.xls","$_SERVER[DOCUMENT_ROOT]\\data\\upload","");
...
<a href="download.php?id=\data\upload\TT144_04aDKTSC.xls">Bấm vào đây để tải file về</a>
</body>