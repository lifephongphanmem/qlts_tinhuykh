			...
			<div class="col-md-12">
				<div class="panel panel-primary" data-collapsed="0">	
							<div class="form-group">
								<h3>Gộp dữ liệu giữa 2 đơn vị</h3>
							</div>
							...
							<div class="modal-content">		
								...
								echo"<div  class='col-sm-2'>";
									echo"<select name='tendvchuyen' class='form-control' id='tendvchuyen'>";
									echo"<option selected='selected' value=''>Đơn vị chuyển</option>";
                                ...
                                $sql1=mysqli_query($con,$sql);
                                echo"<div  class='col-sm-2'>";
                                echo"<select name='tendvden' class='form-control' id='tendvden'>";
                                echo"<option selected='selected' value=''>Đơn vị đến</option>";
                                while ($data=mysqli_fetch_row($sql1))
                                {
                                    echo "<option value='".$data[0]."'>".$data[1]."</option>";
                                }
                                ...
                                echo"</div>";
								?>
                                    <input type="submit" id="capnhatts" name="capnhatts" class="btn btn-blue" value = "Gộp TK">
						</form>						
				</div>
...
if (isset($_POST['capnhatts'])){
    $madvchuyen = $_POST['tendvchuyen'];
    $madvden = $_POST['tendvden'];
    $sqlup = "Update tblbaohong set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tbldanhsachcb set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tbldenghi set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tblhaomon set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tblhientrang set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tblkiemke set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tblkiemken set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tblphongban set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tblqlcc set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tblqlts set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tbltanggiam set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tblthanhly set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tblthanhphankk set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tblthanhphantl set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tbltrangcap set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);

    $sqlup = "Update tblxuatdung set madonvi = '".$madvden."' where madonvi = '".$madvchuyen."'";
    $qr = mysqli_query($con,$sqlup);
