...
$(document).ready(function(){
    $(":input").inputmask();
		...
		<h4 style="text-align: center">Hiện tại phần mềm đang cập nhật các clip hướng dẫn chi tiết.</br> Các bạn hãy quay trở lại sau.</br> Xin lỗi vì sự bất tiện này.</br> Xin chân thành cảm ơn!</h4>
		<br />	
</div>
</div>
<!------ FOOTER --------->
