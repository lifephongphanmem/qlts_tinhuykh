			...
			<div class="col-md-12">
				<div class="panel panel-primary" data-collapsed="0">	
					<div class="form-group">
								<h3>Tra cứu đề nghị xử lý tài sản</h3>
							<div>
						<form role="form" method="POST" class="form-horizontal form-groups-bordered">
						<div class="modal-content">	
								<div class="modal-body">				
						<form role="form" method="POST" action = "tracuudn.php" class="form-horizontal form-groups-bordered">					
							<div class="form-group">
							<span   <?php if (strlen($ma[0]) >= 16){echo "style='display:none';";}?>>
								...
								<?php								
								$sql="select chitiethinhthai from tbldenghi where madonvi Like '$ma[0]%' group by chitiethinhthai";
								$sql1=mysqli_query($con,$sql);
								echo"<div  class='col-sm-2'>";
								...
								<div  class='col-sm-2'>
									...
									<?php
									if ($_POST['hinhthuc'] == "Thu hồi")
									echo '<option selected=\'selected\' value="Thu hồi">Thu hồi</option>';
									if ($_POST['hinhthuc'] == "Bán")
									echo '<option selected=\'selected\' value="Bán">Bán</option>';
									if ($_POST['hinhthuc'] == "Điều chuyển")
									echo '<option selected=\'selected\' value="Điều chuyển">Điều chuyển</option>';
									if ($_POST['hinhthuc'] == "Thanh lý")
									echo '<option selected=\'selected\' value="Thanh lý">Thanh lý</option>';
									if ($_POST['hinhthuc'] == "LD, liên kết")
									echo '<option selected=\'selected\' value="LD, liên kết">LD, liên kết</option>';
									else 
									{
										echo '<option value="Thu hồi">Thu hồi</option>';
										echo '<option value="Bán">Bán</option>';
										echo '<option value="Điều chuyển">Điều chuyển</option>';
										echo '<option value="Thanh lý">Thanh lý</option>';
										echo '<option value="LD, liên kết">LD, liên kết</option>';
									}
									?>
									</select>
								</div>								
								<div class="col-sm-2">
									<input data-inputmask="'alias': 'date'" name="NTTu" placeholder="Từ ngày" type="text" class="form-control" value="<?php if (isset($_POST['NTTu'])){echo $_POST['NTTu'];}?>" id="NTTu">
								</div>								
								<div class="col-sm-2">
									<input data-inputmask="'alias': 'date'" name="NTDen" placeholder="Đến ngày" type="text" class="form-control" value="<?php if (isset($_POST['NTDen'])){echo $_POST['NTDen'];}?>" id="NTDen">
								</div>	
...
{
	$sqlct = "Select chitiethinhthai,tentaisan,tenchitiet,hinhthuc,ngaythang,noidung from tbldenghi where ".($_POST['NTTu']==""? " ngaythang like '%'": "ngaythang > '".doingay($_POST['NTTu'])."'")." and madonvi like '".$ab."%' and ".($_POST['NTDen']==""? " ngaythang like '%'": "ngaythang < '".doingay($_POST['NTDen'])."'")."  and chitiethinhthai like '".($_POST['chitiethinhthai']==""?"%":$_POST['chitiethinhthai'])."' and hinhthuc like '".($_POST['hinhthuc']==""?"%":$_POST['hinhthuc'])."' and ".($_POST['tentaisanvp']==""? " tentaisan like '%'": "tentaisan = '".$_POST['tentaisanvp']."'")." and ".($_POST['tentaisanvt']==""? " tentaisan like '%'": "tentaisan = '".$_POST['tentaisanvt']."'")." and ".($_POST['tentaisanvkt']==""? " tentaisan like '%'": "tentaisan = '".$_POST['tentaisanvkt']."'")." and ".($_POST['tentaisantb']==""? " tentaisan like '%'": "tentaisan = '".$_POST['tentaisantb']."'")."";
}

else if (isset($_POST['capnhatts']))
{
	$sqlct = "Select chitiethinhthai,tentaisan,tenchitiet,hinhthuc,ngaythang,noidung from tbldenghi where ".($_POST['NTTu']==""? " ngaythang like '%'": "ngaythang > '".doingay($_POST['NTTu'])."'")." and madonvi like '".$_POST['tendv']."%' and ".($_POST['NTDen']==""? " ngaythang like '%'": "ngaythang < '".doingay($_POST['NTDen'])."'")."  and chitiethinhthai like '".($_POST['chitiethinhthai']==""?"%":$_POST['chitiethinhthai'])."' and hinhthuc like '".($_POST['hinhthuc']==""?"%":$_POST['hinhthuc'])."' and ".($_POST['tentaisanvp']==""? " tentaisan like '%'": "tentaisan = '".$_POST['tentaisanvp']."'")." and ".($_POST['tentaisanvt']==""? " tentaisan like '%'": "tentaisan = '".$_POST['tentaisanvt']."'")." and ".($_POST['tentaisanvkt']==""? " tentaisan like '%'": "tentaisan = '".$_POST['tentaisanvkt']."'")." and ".($_POST['tentaisantb']==""? " tentaisan like '%'": "tentaisan = '".$_POST['tentaisantb']."'")."";
}

else
{
	$sqlct = "Select chitiethinhthai,tentaisan,tenchitiet,hinhthuc,ngaythang,noidung from tbldenghi where madonvi like '$ab%' ";
}
