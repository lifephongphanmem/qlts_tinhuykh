...
$sql = "Select tentaisan,tenchitiet,ngaynhap,ngaysudung,DTKV,ngansach,nguonkhac,noidung,TKVDAT from tblqlts where TTQLTS = '$tttaisan'";
...
?>
		<h3 style="text-align:center;">CHI TIẾT TÀI SẢN LÀ ĐẤT </h3>
		<div class="row">
			<div class="col-md-12">
					...
					<div class="panel-body">
						<form role="form" method="POST" class="form-horizontal form-groups-bordered">
							<div class="form-group">
								...
								<div class="col-md-4">
									<input name="DTKV" class="form-control" type="text" value = "<?php echo dinhdangso($row[4]); ?>">
								</div>	
								<label  class="col-sm-2 control-label">Ngân sách:</label>
								<div class="col-md-4">
									<input name="ngansach" class="form-control" type="text" value = "<?php echo dinhdangso($row[5]); ?>">
								</div>
								<label  class="col-sm-2 control-label">Nguồn khác:</label>
								<div class="col-md-4">
									<input name="nguonkhac" class="form-control" type="text" value = "<?php echo dinhdangso($row[6]); ?>">
								</div>
								<label  class="col-sm-2 control-label">Nơi sử dụng:</label>
								<div class="col-md-4">
									<input name="noidung" class="form-control" type="text" value = "<?php echo $row[7]; ?>">
								</div>
								<label  class="col-sm-2 control-label">Địa chỉ khuôn viên:</label>
								<div class="col-md-4">
									<input name="TKVDAT" class="form-control" type="text" value = "<?php echo $row[8]; ?>">
								</div>								
							</div>
<div>							
							<label style="margin-left:-30px;" class="col-sm-3 control-label"><strong><b>Thông tin hiện trạng tài sản:</b></strong></label>
								...
								<tbody>
<?php
$sqlhm = "Select ngaythang,phanloai,donvi,soluong from tblhientrang Where TTQLTS = '$tttaisan'";
